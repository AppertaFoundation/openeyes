...
Detailed installation instructions to build each version can be found on the project wiki page [here]([https://github.com/AppertaFoundation/openeyes/wiki/](https://github.com/AppertaFoundation/openeyes/wiki).
