...
<html>
       <head>
               ...
               <style>
                       ...
                       .CodeFragment  { background-color: #BBBBBB; display:none; font:normal normal normal 9pt C
                       .ExpandButton  { background-color: #FFFFFF; font-size: 8pt; width: 20px; height: 20px; ma
               </style>
       </head>
<body>
    ...
    <p/>
    You expand and collapse the code fragments using the + buttons. You can also navigate to the source code by
    on the file names.
    <p/>
    <table>
               ...
               <td>
                       <table>
                               <xsl:for-each select="file">
                                       <tr><td><a><xsl:attribute name="href">../src/<xsl:value-of select="@path"
                               </xsl:for-each>
                       </table>
               </td>
