...
<section class="element <?php echo $element->elementType->class_name?> ondemand<?php if (@$ondemand) {?> hidden<?php }?><?php if ($this->action->id == 'update' && !$element->event_id) {?> missing<?php }?>"
	...
	$form->layoutColumns=array('label'=>2,'field'=>10);?>
	<div class="element-fields">
	<div class="row">
		<div class="large-8 column">
			<div class="row">
				<div class="large-6 column">
					<div class="eye-draw-widget" id="eyedrawwidget_right1">
						<?php
					...
					<div class="large-6 column">
						...
						<?php echo $form->textArea($element, 'report')?>
					</div>
		...
		<div class="large-4 column">
			...
			<?php echo $form->textArea($element, 'complication_notes')?>
		</div>
	</div>
