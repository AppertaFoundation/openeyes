		...
		<div class="row data-row">
			<div class="large-2 column">
				...
				<div class="data-value <?php if (!$element->postop_instructions) {?> none<?php }?>">
					<?php echo $element->postop_instructions ? CHtml::encode($element->postop_instructions) : 'None'?>
				</div>
			</div>
			<div class="large-2 column end">
				<h4 class="data-title">
					<?php echo CHtml::encode($element->getAttributeLabel('comments'))?></h4>
				<div class="data-value <?php if (!$element->comments) {?> none<?php }?>">
					<?php echo $element->comments ? CHtml::encode($element->comments) : 'None'?>
				</div>
			</div>
		</div>
	</div>
