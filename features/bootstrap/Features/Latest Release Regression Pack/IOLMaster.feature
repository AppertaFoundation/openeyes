...
@iolTest_1.2
  Scenario Outline: Test Scenarios for base file format import. Multi-Formula, Single-Lens Format
   ...
   Then I check for "SRK/T" in formula dropdown for "<eyeside2>"
    ...
    Examples:
      ...
      |master  |admin|admin|Barking        |Cataract firm (Cataract)|Admin|System|File Watcher|1.2.276.0.75.2.1.10.0.2.150925110222375.15295058.1554_0000_000001_144317555300a9.dcm |File Copied Successfully!|http://iolmaster.openeyes.org.uk/TestHarness/DICOMFileWatcher|Home      |1008007|                   |cataract  |             |View        |Edit        |The event has been added to this episode.|22.71   |43.32   |44.58   |341.5    |-1.26  |3.11|9     |99    |9         |Phakic    |22.68   |43.16   |45.49   |306.9    |-2.33  |3.03|173   |83    |173       |Phakic    |right   |left    |
  ...
  Scenario Outline: Test Scenarios for base file format import with only Left Eye Data
   ...
   #And I close the site and firm selection popup
    ...
    Examples:
      |mainPage|uname|pwd  |siteName/Number|firmName/Number         |page |tab   |subTab      |DICOMFile                                                                            |message                  |url                                                          |primaryTab|hospNum|biometryEventExists|speciality|eventDateTime|biometryTab1|biometryTab2|info-alert1                              |ALValue1|K1Value1|K2Value1|SNRValue1|DeltaK1|ACD1|K1Deg1|K2Deg1|DeltaKDeg1|eyeStatus1|ALValue2|K1Value2|K2Value2|SNRValue2|DeltaK2|ACD2|K1Deg2|K2Deg2|DeltaKDeg2|eyeStatus2|eyeSide1|eyeSide2|
      |master  |admin|admin|Barking        |Cataract firm (Cataract)|Admin|System|File Watcher|1.2.276.0.75.2.1.10.0.2.151102184903343.15295058.14365_0000_000001_14464901580115.dcm|File Copied Successfully!|http://iolmaster.openeyes.org.uk/TestHarness/DICOMFileWatcher|Home      |1007940|                   |cataract  |             |View        |Edit        |The event has been added to this episode.|        |        |        |         |       |    |      |      |          |          |24.94   |40.81   |42.08   |129.1    |-1.27  |2.62|15    |105   |15        |Phakic    |right   |left    |
      |master  |admin|admin|Barking        |Cataract firm (Cataract)|Admin|System|File Watcher|1.2.276.0.75.2.1.10.0.2.150731171549390.15295058.23522_0000_000001_14383597240035.dcm|File Copied Successfully!|http://iolmaster.openeyes.org.uk/TestHarness/DICOMFileWatcher|Home      |1007921|                   |cataract  |             |View        |Edit        |The event has been added to this episode.|        |        |        |         |       |    |      |      |          |          |22.12   |45.49   |45.67   |116.1    |-0.18  |2.29|45    |135   |45        |Phakic    |right   |left    |
