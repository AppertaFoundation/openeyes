...
Feature: Operation Booking Test
  ...
  Firm :  MR Clinic (Medical Retina)
    ...
    Examples:
      |uname|pwd  |lastName|firstName|event                            |diagnosis_eye|operation_eye|complexity |procedure          |operation_site|equipment_details|operation_comment|rtt_comment|schedule_option|name   |number   |Ana_type|overnight_option|diagnosis|
      |admin|admin|Coffin, |Violet   |OphTrOperationbooking            |Both         |Left         |High       | Biopsy of choroid |Kings         |testing          |testing testing  |testing    |am             |testing|012345678|LA        |Pre-op        |Amblyopia|
