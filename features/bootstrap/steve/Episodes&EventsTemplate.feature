...
Feature: Create New Anaesthetic Satisfaction Audit
  ...
  Scenario Outline: Login and create a Anaesthetic Satisfaction Audit
    ...
    Then I enter Comments "Here are some test comments included directly in this statement here instead of the example table being displayed off the page"
