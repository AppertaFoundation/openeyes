...
class m160815_113951_patient_factor_data extends CDbMigration
{
	public function up()
	{
		...
		$this->insert('ophcocvi_clinicinfo_patient_factor',array('name'=>'Does the patient have any other medical conditions that may be relevant? ','require_comments'=>'1','comments_label'=>'Please specify','code'=>'PF1','display_order'=>4));
		$this->insert('ophcocvi_clinicinfo_patient_factor',array('name'=>'Are there any concerns about how the sight problem or the prospect of registration is affecting the patient emotionally? ','require_comments'=>'1','comments_label'=>'Please make a note of  the concerns here:','code'=>'PF1','display_order'=>5));
		$this->insert('ophcocvi_clinicinfo_patient_factor',array('name'=>'Would the patient benefit from a discussion with a rehabilitation worker about practical matters such as mobility? ','code'=>'PF1','display_order'=>6));
		$this->insert('ophcocvi_clinicinfo_patient_factor',array('name'=>'Would the patient benefit from a discussion with a rehabilitation worker about practical matters such as daily living skills? ','code'=>'PF1','display_order'=>7));
