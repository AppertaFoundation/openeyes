...
<div class="panel admin">
	<label for="adminconfirmdate">Set latest letter sent to be:</label> <input
		class="small fixed-width" type="text" />
</div>
<div class="panel admin">
...
<button class="small secondary">Confirm selected</button>