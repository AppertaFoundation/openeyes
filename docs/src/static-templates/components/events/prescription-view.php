<div class="large-10 column event view ophdrprescription">
	...
	<div class="event-content">
		...
		<div class="row">
			<div class="large-12 column">
				...
				<!-- Success message -->
				<div class="alert-box success with-icon">Prescription created.</div>

				<!-- Alert message -->
				<div class="alert-box alert with-icon">This prescription is a draft
					and can still be edited.</div>

				<h3 class="element-title">Prescriptions</h3>
				...
				<table class="prescriptions">
					...
					<tbody>
						<tr class="prescription-item odd">
							<td class="prescription-label">chlorAMPhenicol 1% eye ointment</td>
							<td>1 strip(s)</td>
							<td>Eye (Left)</td>
							<td>nocte</td>
							<td>24 hours</td>
				...
				<div class="metadata">
					<span class="info"> Prescription created by <span class="user">Enoch
