									...
									<div class="row collapse">
										<div class="large-10 column">
											<div class="dropdown-row">
												<select name="Element_OphCoTherapyapplication_Therapydiagnosis[right_diagnosis1_id]" id="Element_OphCoTherapyapplication_Therapydiagnosis_right_diagnosis1_id">
													<option value="">- Please select -</option>
												</select>
											</div>
											<div class="autocomplete-row hide">
												<input placeholder="search for diagnosis" id="Element_OphCoTherapyapplication_Therapydiagnosis_right_diagnosis1_id_searchbox" type="text" value="" name="ignore_Element_OphCoTherapyapplication_Therapydiagnosis[right_diagnosis1_id]" class="ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
											</div>
										</div>
										<div class="large-2 column">
											<div class="postfix">
												<button class="small button-icon small" id="Element_OphCoTherapyapplication_Therapydiagnosis_right_diagnosis1_id_search">
