<div class="large-10 column event ophtroperationbooking edit">
	...
	<div class="event-content">
		...
		<div class="panel">
			<span class="patient"><span class="patient-surname">COFFIN</span>, <span
				class="patient-name">Violet</span> (1009465)</span>
		</div>

		<div id="firmSelect">
			<div class="element-fields change-firm">
				<div class="field-row">
					<span class="field-label"> Viewing the schedule for <strong>Abou-Rayyah
							Yassir</strong>
					</span> <select id="firm_id" class="inline firm-switcher">
				...
				<div id="details">
					<div id="dates" class="clearfix">
						...
						<div class="left" id="month_back">
							<div class="primary" id="previous_month">
								<a class="button primary"
									href="/OphTrOperationbooking/booking/schedule/156?firm_id=134&amp;date=201310">&#x25C0;&nbsp;&nbsp;previous
									month</a>
							</div>
						</div>
						<div class="right" id="month_forward">
							<div id="next_month">
								<a class="button primary"
									href="/OphTrOperationbooking/booking/schedule/156?firm_id=134&amp;date=201312"><span
									class="button-span button-span-blue">next
										month&nbsp;&nbsp;&#x25B6;</span></a>
							</div>
						</div>
					</div>
							...
							<tr>
								<td colspan="5">
									<div id="key">
										...
										<div class="container" id="limited">
											<div class="color_box"></div>
											<div class="label">Limited Slots</div>
										</div>
										...
										<div class="container" id="closed">
											<div class="color_box"></div>
											<div class="label">Theatre Closed</div>
										</div>
										<div class="container" id="selected_date">
											<div class="color_box"></div>
											<div class="label">Selected Date</div>
										</div>
										<div class="container" id="outside_rtt">
											<div class="color_box"></div>
											<div class="label">Outside RTT</div>
										</div>
									</div>
								</td>
							</tr>
