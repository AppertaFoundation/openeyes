...
<div class="element-fields row">
	...
	<?php echo $form->multiSelectList($element, 'MultiSelect_disorders', 'disorderss', 'ophcocvi_clinicinfo_disorders_id', CHtml::listData(OEModule\OphCoCvi\models\OphCoCvi_ClinicalInfo_Disorders::model()->findAll(array('order'=>'display_order asc')),'id','name'), $element->ophcocvi_clinicinfo_disorders_defaults, array('empty' => '- Please select -', 'label' => 'Disorders'))?>
