...
<div class="element-fields row">
	...
	<?php echo $form->multiSelectList($element, 'MultiSelect_disorders', 'disorders', 'ophcocvi_clinicinfo_disorders_id', CHtml::listData(OEModule\OphCoCvi\models\OphCoCvi_ClinicalInfo_Disorder::model()->findAll(array('order'=>'display_order asc')),'id','name'), null, array('empty' => '- Please select -', 'label' => 'Disorders'))?>
