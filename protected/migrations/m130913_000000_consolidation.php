	...
	class m130913_000000_consolidation extends OEMigration
	{
		...
		public function up(){
			...
			if ($existing_migrations == 1) {
				...
				$previous_migration = $this->getDbConnection()->createCommand("SELECT * FROM `tbl_migration` WHERE version = 'm130912_153500_remove_unneeded_cols_from_user_session'")->execute();
				if ($previous_migration) {
					// Previous migration was applied, safe to consolidate
					echo "Consolidating old migration data";
					$this->execute("DELETE FROM `tbl_migration` WHERE version < 'm130913_000000_consolidation'");
				} else {
		...
		public function createTables()
		{
			...
			$this->execute("CREATE TABLE `address_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `allergy` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `anaesthetic_agent` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `anaesthetic_complication` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `display_order` tinyint(3) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `anaesthetic_delivery` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `display_order` tinyint(3) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `anaesthetic_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `anaesthetist` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `display_order` tinyint(3) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `audit` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  ...
				  `request_uri` varchar(255) COLLATE utf8_bin DEFAULT '',
			...
			$this->execute("CREATE TABLE `audit_action` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `audit_ipaddr` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `audit_module` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1901-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `audit_server` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1901-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `audit_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1901-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `audit_useragent` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `benefit` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `commissioning_body` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `commissioning_body_patient_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `commissioning_body_practice_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `commissioning_body_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `commissioning_body_service` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `code` varchar(16) COLLATE utf8_bin DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `commissioning_body_service_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `commissioning_body_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `shortname` varchar(16) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `common_ophthalmic_disorder` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `common_previous_operation` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(1024) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `common_systemic_disorder` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `disorder_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `complication` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(255) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `contact_label` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `contact_location` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `contact_id` int(10) unsigned NOT NULL,
				  `site_id` int(10) unsigned DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `contact_metadata` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `contact_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `disorder` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `disorder_tree` (
			...
			$this->execute("CREATE TABLE `drug` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `drug_allergy_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `drug_duration` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `created_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `drug_form` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `created_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `drug_frequency` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `drug_route` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `created_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `drug_route_option` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `drug_set` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin DEFAULT NULL,
				  `subspecialty_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `drug_set_item` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `drug_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `drug_set_item_taper` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `drug_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `created_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `element_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `element_type_anaesthetic_agent` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `element_type_anaesthetic_complication` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `element_type_anaesthetic_delivery` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `element_type_anaesthetic_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `element_type_anaesthetist` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `element_type_eye` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `element_type_priority` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `episode` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `patient_id` int(10) unsigned NOT NULL,
				  `firm_id` int(10) unsigned DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `episode_status` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `ethnic_group` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `event_group` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `event_issue` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `family_history` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `patient_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `family_history_condition` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `display_order` tinyint(1) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `family_history_relative` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `display_order` tinyint(1) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `family_history_side` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `display_order` tinyint(1) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `firm` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `firm_user_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `gender` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(16) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `import_source` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `institution` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(255) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `issue` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `letter_template` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `subspecialty_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `medication` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `patient_id` int(10) unsigned NOT NULL,
				  `drug_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `nsc_grade` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `opcs_code` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `operative_device` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `patient` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `patient_allergy_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `patient_id` int(10) unsigned NOT NULL,
				  `allergy_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `patient_contact_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `patient_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `patient_oph_info` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `patient_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `patient_oph_info_cvi_status` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `patient_shortcode` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `event_type_id` int(10) unsigned DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `period` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(128) COLLATE utf8_bin NOT NULL,
				  `display_order` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `phrase` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `phrase_by_firm` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `phrase` text COLLATE utf8_bin,
				  `section_id` int(10) unsigned NOT NULL,
				  `display_order` int(10) unsigned DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `phrase_by_subspecialty` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `phrase` text COLLATE utf8_bin,
				  `section_id` int(10) unsigned NOT NULL,
				  `display_order` int(10) unsigned DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `phrase_name` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(255) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `practice` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `previous_operation` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `patient_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `priority` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(10) COLLATE utf8_bin DEFAULT NULL,
				  PRIMARY KEY (`id`)
				) 
			...
			$this->execute("CREATE TABLE `proc` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `proc_opcs_assignment` (
			...
			$this->execute("CREATE TABLE `proc_subspecialty_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `proc_id` int(10) unsigned NOT NULL,
				  `subspecialty_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `proc_subspecialty_subsection_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `proc_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `procedure_additional` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `proc_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `procedure_benefit` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `proc_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `procedure_complication` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `proc_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `protected_file` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `referral` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `referral_episode_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `referral_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `secondary_diagnosis` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `disorder_id` int(10) unsigned NOT NULL,
				  `eye_id` int(10) unsigned DEFAULT NULL,
				  `patient_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `section` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(255) COLLATE utf8_bin DEFAULT NULL,
			...
			$this->execute("CREATE TABLE `section_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(255) COLLATE utf8_bin DEFAULT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `service` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `service_subspecialty_assignment` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `setting_field_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
				  `last_modified_date` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
			...
			$this->execute("CREATE TABLE `setting_firm` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `firm_id` int(10) unsigned NOT NULL,
				  `element_type_id` int(10) unsigned NOT NULL,
				  `key` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `setting_installation` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
				  `key` varchar(64) COLLATE utf8_bin NOT NULL,
				  `value` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `setting_institution` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `institution_id` int(10) unsigned NOT NULL,
				  `element_type_id` int(10) unsigned NOT NULL,
				  `key` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `setting_metadata` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `element_type_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `setting_site` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `setting_specialty` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			...
			$this->execute("CREATE TABLE `setting_subspecialty` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `subspecialty_id` int(10) unsigned NOT NULL,
				  `element_type_id` int(10) unsigned NOT NULL,
				  `key` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `setting_user` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `user_id` int(10) unsigned NOT NULL,
				  `element_type_id` int(10) unsigned NOT NULL,
				  `key` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `site` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(255) COLLATE utf8_bin NOT NULL,
				  `remote_id` varchar(10) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `site_subspecialty_anaesthetic_agent` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `site_id` int(10) unsigned NOT NULL,
				  `subspecialty_id` int(10) unsigned NOT NULL,
				  `anaesthetic_agent_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `site_subspecialty_anaesthetic_agent_default` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `site_id` int(10) unsigned NOT NULL,
				  `subspecialty_id` int(10) unsigned NOT NULL,
				  `anaesthetic_agent_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `site_subspecialty_drug` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `site_id` int(10) unsigned NOT NULL,
				  `subspecialty_id` int(10) unsigned NOT NULL,
				  `drug_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `site_subspecialty_operative_device` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `site_id` int(10) unsigned NOT NULL,
				  `subspecialty_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `specialty` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
			...
			$this->execute("CREATE TABLE `specialty_type` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(64) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `subspecialty` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `name` varchar(40) COLLATE utf8_bin NOT NULL,
			...
			$this->execute("CREATE TABLE `subspecialty_subsection` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `subspecialty_id` int(10) unsigned NOT NULL,
				  `name` varchar(255) CHARACTER SET latin1 NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `tbl_audit_trail` (
			...
			$this->execute("CREATE TABLE `user_firm` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `user_id` int(10) unsigned NOT NULL,
				  `firm_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `user_firm_preference` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `user_id` int(10) unsigned NOT NULL,
				  `firm_id` int(10) unsigned NOT NULL,
			...
			$this->execute("CREATE TABLE `user_firm_rights` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `user_id` int(10) unsigned NOT NULL,
				  `firm_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `user_service_rights` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `user_id` int(10) unsigned NOT NULL,
				  `service_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
			...
			$this->execute("CREATE TABLE `user_site` (
				  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
				  `user_id` int(10) unsigned NOT NULL,
				  `site_id` int(10) unsigned NOT NULL,
				  `last_modified_user_id` int(10) unsigned NOT NULL DEFAULT '1',
