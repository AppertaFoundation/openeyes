DELETE FROM openeyes.ref_medication_set WHERE ref_set_id IN (SELECT id FROM openeyes.ref_set WHERE `name` = 'DM+D AMP');
DELETE FROM openeyes.ref_medication_set WHERE ref_set_id IN (SELECT id FROM openeyes.ref_set WHERE `name` = 'DM+D VMP');
DELETE FROM openeyes.ref_medication_set WHERE ref_set_id IN (SELECT id FROM openeyes.ref_set WHERE `name` = 'DM+D VTM');
