...
class m191125_091623_create_event_icon_table extends CDbMigration
{
    ...
    public function up()
    {
        $icon_names = ['i-genCiDiamond', 'i-genCiDoc', 'i-genCiDocHole', 'i-genCiFour', 'i-genCiGrid',
            ...
            'i-CoLetterIn', 'i-CoLetterOut', 'i-CoMedia', 'i-CoPatientConsent', 'i-CoReferral', 'i-CoTelephoneCall',
            'i-DrDrops', 'i-DrPills', 'i-DrPrescription', 'i-DrSpecsPrescription', 'i-ImOCT', 'i-ImPhoto',
