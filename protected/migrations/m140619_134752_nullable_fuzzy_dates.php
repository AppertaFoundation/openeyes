...
class m140619_134752_nullable_fuzzy_dates extends CDbMigration
{
	public function up()
	{
		...
		Yii::app()->db->createCommand('update previous_operation set date = null where date =\'0000-00-00\'')->query();
	}

	public function down()
	{
		Yii::app()->db->createCommand('update previous_operation set date = \'0000-00-00\' where date is null')->query();
