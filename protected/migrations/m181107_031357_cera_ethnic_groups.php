...
class m181107_031357_cera_ethnic_groups extends OEMigration
{
  ...
  public function safeUp()
  {
    ...
    $this->insert('ethnic_group', array('name' => 'Indigenous Australia', 'code' => 'S', 'display_order' => '180'));
    $this->insert('ethnic_group', array('name' => 'Greek', 'code' => 'C', 'display_order' => '190'));
    $this->insert('ethnic_group', array('name' => 'Italians', 'code' => 'C', 'display_order' => '200'));
  ...
  public function safeDown()
  {
    ...
    $this->delete('ethnic_group', 'name = "Italians"');
  }
