...
class m180504_085420_medication_management_tables extends OEMigration
{
    public function up()
    {
        ...
        $this->insertMultiple('medication_usage_code', [
            ['usage_code' => 'COMMON_OPH', 'name' => 'Common Ophthalmic'],
            ['usage_code' => 'COMMON_SYSTEMIC', 'name' => 'Common Systemic'],
            ['usage_code' => 'PRESCRIPTION_SET', 'name' => 'Prescription'],
            ['usage_code' => 'DrugTag', 'name' => 'Drug Tags', 'hidden' => 1, 'active' => 0],
            ['usage_code' => 'Formulary', 'name' => 'Formulary'],
