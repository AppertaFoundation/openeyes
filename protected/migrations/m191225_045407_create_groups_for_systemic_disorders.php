...
class m191225_045407_create_groups_for_systemic_disorders extends OEMigration
{
    public function up()
    {
        ...
        $this->addOEColumn('common_systemic_disorder', 'display_order', 'int default 1');
        $this->addOEColumn('common_systemic_disorder', 'group_id', 'int NULL');
    ...
    public function down()
    {
        ...
        $this->dropOEColumn('common_systemic_disorder', 'display_order');
        $this->dropOEColumn('common_systemic_disorder', 'group_id');
