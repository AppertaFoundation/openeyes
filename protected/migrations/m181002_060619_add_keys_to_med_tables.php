...
class m181002_060619_add_keys_to_med_tables extends CDbMigration
{
	public function up()
	{
	    $this->execute("ALTER TABLE `medication_form` ADD KEY (`term`);
                    ...
                    ALTER TABLE `medication_form` COLLATE=utf8_general_ci;");
	}
