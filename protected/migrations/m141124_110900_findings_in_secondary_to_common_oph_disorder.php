...
class m141124_110900_findings_in_secondary_to_common_oph_disorder extends CDbMigration
{
    public function up()
    {
        ...
        $this->alterColumn('secondaryto_common_oph_disorder', 'disorder_id', 'BIGINT unsigned');
    }

    public function down()
    {
        $this->alterColumn('secondaryto_common_oph_disorder', 'disorder_id', 'BIGINT unsigned NOT NULL');
