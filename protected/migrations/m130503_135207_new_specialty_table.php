...
class m130503_135207_new_specialty_table extends CDbMigration
{
	public function up()
	{
		...
		$this->update('specialty',array('specialty_type_id'=>1),'code=130');
		$this->update('specialty',array('specialty_type_id'=>6),'code=990');

		$this->insert('specialty',array('name'=>'General Surgery','code'=>100,'specialty_type_id'=>1,'default_title'=>'Consultant Surgeon'));
		$this->insert('specialty',array('name'=>'Urology','code'=>101,'specialty_type_id'=>1,'default_title'=>'ConsultantUrologist'));
		$this->insert('specialty',array('name'=>'Trauma & Orthopaedics','code'=>110,'specialty_type_id'=>1,'default_title'=>'Consultant Orthopaedic Surgeon'));
		$this->insert('specialty',array('name'=>'ENT','code'=>120,'specialty_type_id'=>1,'default_title'=>'Consultant ENT Surgeon'));
		$this->insert('specialty',array('name'=>'Ophthalmology','code'=>130,'specialty_type_id'=>1,'default_title'=>'Consultant Ophthalmologist'));
		$this->insert('specialty',array('name'=>'Oral Surgery','code'=>140,'specialty_type_id'=>1,'default_title'=>'Consultant Oral Surgeon'));
		$this->insert('specialty',array('name'=>'Restorative Dentistry','code'=>141,'specialty_type_id'=>1,'default_title'=>'Consultant Dental Surgeon'));
		$this->insert('specialty',array('name'=>'Paediatric Dentistry','code'=>142,'specialty_type_id'=>1,'default_title'=>'Consultant Dental Surgeon'));
		$this->insert('specialty',array('name'=>'Orthodontics','code'=>143,'specialty_type_id'=>1,'default_title'=>'Consultant Orthodontist'));
		$this->insert('specialty',array('name'=>'Oral & Maxillo Facial Surgery','code'=>145,'specialty_type_id'=>1,'default_title'=>'Consultant Maxillo Facial Surgeon'));
		$this->insert('specialty',array('name'=>'Endodontics','code'=>146,'specialty_type_id'=>1,'default_title'=>'Consultant Endontic Surgeon'));
		$this->insert('specialty',array('name'=>'Periodontics','code'=>147,'specialty_type_id'=>1,'default_title'=>'Consultant Peridontic Surgeon'));
		$this->insert('specialty',array('name'=>'Prosthodontics','code'=>148,'specialty_type_id'=>1,'default_title'=>'Consultant Prosthodontist'));
		$this->insert('specialty',array('name'=>'Surgical Dentistry','code'=>149,'specialty_type_id'=>1,'default_title'=>'Consultant Dental Surgeon'));
		$this->insert('specialty',array('name'=>'Neurosurgery','code'=>150,'specialty_type_id'=>1,'default_title'=>'Consultant Neurosurgeon'));
		$this->insert('specialty',array('name'=>'Plastic Surgery','code'=>160,'specialty_type_id'=>1,'default_title'=>'Consultant Plastic Surgeon'));
		$this->insert('specialty',array('name'=>'Cardiothoracic Surgery','code'=>170,'specialty_type_id'=>1,'default_title'=>'Consultant Cardiothoracic Surgeon'));
		$this->insert('specialty',array('name'=>'Paediatric Surgery','code'=>171,'specialty_type_id'=>1,'default_title'=>'Consultant Paediatric Surgeon'));
		$this->insert('specialty',array('name'=>'Accident & Emergency','code'=>180,'specialty_type_id'=>1,'default_title'=>'Accident & Emergency Consultant'));
		$this->insert('specialty',array('name'=>'Anaesthetics','code'=>190,'specialty_type_id'=>1,'default_title'=>'Consultant Anaesthetist'));
		$this->insert('specialty',array('name'=>'Critical Care Medicine','code'=>192,'specialty_type_id'=>2,'default_title'=>'Consultant in Critical Care'));
		$this->insert('specialty',array('name'=>'General Medicine','code'=>300,'specialty_type_id'=>2,'default_title'=>'Consultant Physician'));
		$this->insert('specialty',array('name'=>'Gastroenterology','code'=>301,'specialty_type_id'=>2,'default_title'=>'Consultant Gastroenterologist'));
		$this->insert('specialty',array('name'=>'Endocrinology','code'=>302,'specialty_type_id'=>2,'default_title'=>'Consultant Endocrinologist'));
		$this->insert('specialty',array('name'=>'Clinical Haematology','code'=>303,'specialty_type_id'=>2,'default_title'=>'Consultant Haematologist'));
		$this->insert('specialty',array('name'=>'Clinical Physiology','code'=>304,'specialty_type_id'=>2,'default_title'=>'Consultant Physiologist'));
		$this->insert('specialty',array('name'=>'Clinical Pharmacology','code'=>305,'specialty_type_id'=>2,'default_title'=>'Consultant Pharmacologist'));
		$this->insert('specialty',array('name'=>'Audiological Medicine','code'=>310,'specialty_type_id'=>2,'default_title'=>'Consultant Audiologist'));
		$this->insert('specialty',array('name'=>'Clinical Genetics','code'=>311,'specialty_type_id'=>2,'default_title'=>'Consultant Clinical Geneticist'));
		$this->insert('specialty',array('name'=>'Clinical Immunology and Allergy','code'=>313,'specialty_type_id'=>2,'default_title'=>'Consultant Immunologist'));
		$this->insert('specialty',array('name'=>'Rehabilitation','code'=>314,'specialty_type_id'=>2,'default_title'=>'Consultant in Rehabilitation'));
		$this->insert('specialty',array('name'=>'Palliative Medicine','code'=>315,'specialty_type_id'=>2,'default_title'=>'Consultant in Palliative Care'));
		$this->insert('specialty',array('name'=>'Cardiology','code'=>320,'specialty_type_id'=>2,'default_title'=>'Consultant Cardiologist'));
		$this->insert('specialty',array('name'=>'Paediatric Cardiology','code'=>321,'specialty_type_id'=>2,'default_title'=>'Consultant Paediatric Cardiologist'));
		$this->insert('specialty',array('name'=>'Dermatology','code'=>330,'specialty_type_id'=>2,'default_title'=>'Consultant Dermatologist'));
		$this->insert('specialty',array('name'=>'Respiratory Medicine','code'=>340,'specialty_type_id'=>2,'default_title'=>'Consultant Physician'));
		$this->insert('specialty',array('name'=>'Infectious Diseases','code'=>350,'specialty_type_id'=>2,'default_title'=>'Consultant in Infectious Diseases'));
		$this->insert('specialty',array('name'=>'Tropical Medicine','code'=>352,'specialty_type_id'=>2,'default_title'=>'Consultant in Tropical Medicine'));
		$this->insert('specialty',array('name'=>'Genitourinary Medicine','code'=>360,'specialty_type_id'=>2,'default_title'=>'Consultant in Genitourinary Medicine'));
		$this->insert('specialty',array('name'=>'Nephrology','code'=>361,'specialty_type_id'=>2,'default_title'=>'Consultant Nephrologist'));
		$this->insert('specialty',array('name'=>'Medical Oncology','code'=>370,'specialty_type_id'=>2,'default_title'=>'Consultant Oncologist'));
		$this->insert('specialty',array('name'=>'Nuclear Medicine','code'=>371,'specialty_type_id'=>2,'default_title'=>'Consultant in Nuclear Medicine'));
		$this->insert('specialty',array('name'=>'Neurology','code'=>400,'specialty_type_id'=>2,'default_title'=>'Consultant Neurologist'));
		$this->insert('specialty',array('name'=>'Clinical Neuro-physiology','code'=>401,'specialty_type_id'=>2,'default_title'=>'Consultant Neuro-Physiologist'));
		$this->insert('specialty',array('name'=>'Rheumatology','code'=>410,'specialty_type_id'=>2,'default_title'=>'Consultant Rheumatologist'));
		$this->insert('specialty',array('name'=>'Paediatrics','code'=>420,'specialty_type_id'=>2,'default_title'=>'Consultant Paediatrician'));
		$this->insert('specialty',array('name'=>'Paediatric Neurology','code'=>421,'specialty_type_id'=>2,'default_title'=>'Consultant Paediatric Neurologist'));
		$this->insert('specialty',array('name'=>'Geriatric Medicine','code'=>430,'specialty_type_id'=>2,'default_title'=>'Consultant Geriatrician'));
		$this->insert('specialty',array('name'=>'Dental Medicine Specialties','code'=>450,'specialty_type_id'=>2,'default_title'=>'Consultant Physician'));
		$this->insert('specialty',array('name'=>'Medical Ophthalmology','code'=>460,'specialty_type_id'=>2,'default_title'=>'Consultant Ophthalmologist'));
		$this->insert('specialty',array('name'=>'Obstetrics','code'=>501,'specialty_type_id'=>2,'default_title'=>'Consultant Obstetrician'));
		$this->insert('specialty',array('name'=>'Gynaecology','code'=>502,'specialty_type_id'=>2,'default_title'=>'Consultant Gynaecologist'));
		$this->insert('specialty',array('name'=>'Midwife Episode','code'=>560,'specialty_type_id'=>2,'default_title'=>'Consultant'));
		$this->insert('specialty',array('name'=>'Learning Disability','code'=>700,'specialty_type_id'=>3,'default_title'=>'Consultant in Learning Disability'));
		$this->insert('specialty',array('name'=>'Adult Mental Illness','code'=>710,'specialty_type_id'=>3,'default_title'=>'Consultant Psychiatrist'));
		$this->insert('specialty',array('name'=>'Child and Adolescent Psychiatry','code'=>711,'specialty_type_id'=>3,'default_title'=>'Consultant Psychiatrist'));
		$this->insert('specialty',array('name'=>'Forensic Psychiatry','code'=>712,'specialty_type_id'=>3,'default_title'=>'Consultant Psychiatrist'));
		$this->insert('specialty',array('name'=>'Psychotherapy','code'=>713,'specialty_type_id'=>3,'default_title'=>'Consultant Psychotherapist'));
		$this->insert('specialty',array('name'=>'Old Age Psychiatry','code'=>715,'specialty_type_id'=>3,'default_title'=>'Consultant Psychiatrist'));
		$this->insert('specialty',array('name'=>'Clinical Oncology','code'=>800,'specialty_type_id'=>4,'default_title'=>'Consultant Oncologist'));
		$this->insert('specialty',array('name'=>'Radiology','code'=>810,'specialty_type_id'=>4,'default_title'=>'Consultant Radiologist'));
		$this->insert('specialty',array('name'=>'General Pathology','code'=>820,'specialty_type_id'=>5,'default_title'=>'Consultant Pathologist'));
		$this->insert('specialty',array('name'=>'Blood Transfusion','code'=>821,'specialty_type_id'=>5,'default_title'=>'Consultant Haematologist'));
		$this->insert('specialty',array('name'=>'Chemical Pathology','code'=>822,'specialty_type_id'=>5,'default_title'=>'Consultant Pathologist'));
		$this->insert('specialty',array('name'=>'Haematology','code'=>823,'specialty_type_id'=>5,'default_title'=>'Consultant Haematologist'));
		$this->insert('specialty',array('name'=>'Histopathology','code'=>824,'specialty_type_id'=>5,'default_title'=>'Consultant Pathologist'));
		$this->insert('specialty',array('name'=>'Immunopathology','code'=>830,'specialty_type_id'=>5,'default_title'=>'Consultant Pathologist'));
		$this->insert('specialty',array('name'=>'Medical Microbiology and Virology','code'=>831,'specialty_type_id'=>5,'default_title'=>'Consultant Microbiologist'));
		$this->insert('specialty',array('name'=>'Community Medicine','code'=>900,'specialty_type_id'=>6,'default_title'=>'Consultant in Community Medicine'));
		$this->insert('specialty',array('name'=>'Occupational Medicine','code'=>901,'specialty_type_id'=>6,'default_title'=>'Consultant in Occupational Medicine'));
		$this->insert('specialty',array('name'=>'Community Health Services Dental','code'=>902,'specialty_type_id'=>6,'default_title'=>'Consultant in Community Health'));
		$this->insert('specialty',array('name'=>'Public Health Medicine','code'=>903,'specialty_type_id'=>6,'default_title'=>'Public Health Consultant'));
		$this->insert('specialty',array('name'=>'Public Health Dental','code'=>904,'specialty_type_id'=>6,'default_title'=>'Public Health Dental Consultant'));
		$this->insert('specialty',array('name'=>'Nursing Episode','code'=>950,'specialty_type_id'=>6,'default_title'=>'Consultant'));
		$this->insert('specialty',array('name'=>'Allied Health Professional Episode','code'=>960,'specialty_type_id'=>6,'default_title'=>'Consultant'));
	}
