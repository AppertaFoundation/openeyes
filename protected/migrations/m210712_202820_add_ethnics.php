...
class m210712_202820_add_ethnics extends CDbMigration
{
    public function up()
    {
    ...
    {
        $this->execute("DELETE FROM ethnic_group");
        $this->dropColumn('id_assignment', 'describe_needs');
        $this->dropColumn('ethnic_group', 'describe_needs');

        $this->dropColumn('id_assignment', 'describe_needs');
        $this->dropColumn('ethnic_group_version', 'describe_needs');
    }
}
