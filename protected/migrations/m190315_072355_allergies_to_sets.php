...
class m190315_072355_allergies_to_sets extends OEMigration
{
    public function safeUp()
    {
        ...
        $this->execute("INSERT INTO medication_set (`name`, `automatic`) SELECT CONCAT('Allergy_', ophciexamination_allergy.`name`), 1 FROM ophciexamination_allergy WHERE active = 1 GROUP BY `name`");
