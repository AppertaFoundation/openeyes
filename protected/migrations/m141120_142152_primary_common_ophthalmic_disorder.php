...
class m141120_142152_primary_common_ophthalmic_disorder extends CDbMigration
{
    public function up()
    {
        $this->addColumn('common_ophthalmic_disorder', 'alternate_disorder_id', 'BIGINT UNSIGNED NULL DEFAULT NULL');
        $this->addColumn('common_ophthalmic_disorder_version', 'alternate_disorder_id', 'BIGINT UNSIGNED NULL DEFAULT NULL');
