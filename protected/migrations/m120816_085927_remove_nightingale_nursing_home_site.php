...
class m120816_085927_remove_nightingale_nursing_home_site extends CDbMigration
{
	public function up()
	{
		...
		if ($db->schema->getTable('et_ophcocorrespondence_letter_macro')) {
			$this->delete('et_ophcocorrespondence_letter_macro','site_id=13');
		}
		if ($db->schema->getTable('et_ophcocorrespondence_letter_string')) {
			$this->delete('et_ophcocorrespondence_letter_string','site_id=13');
		}
		if ($db->schema->getTable('et_ophtroperationnote_site_subspecialty_postop_instructions')) {
			$this->delete('et_ophtroperationnote_site_subspecialty_postop_instructions','site_id=13');
		}
		if ($db->schema->getTable('et_ophtroperationnote_postop_site_subspecialty_drug')) {
