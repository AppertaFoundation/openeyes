...
class ElementPosteriorSegmentTest extends CDbTestCase
{
	...
	public $fixtures = array(
		...
		'events' => 'Event',
		'elements' => 'ElementPosteriorSegment'
	);
	...
	public function setUp()
	{
		...
		$this->element = new ElementPosteriorSegment($this->user->id, $this->firm->id, $this->patient->id);
	}
	...
	{
		$this->assertEquals('ElementPosteriorSegment', get_class(ElementPosteriorSegment::model()));
	}

	public function testUpdate()
	{
		$element = $this->elements('elementPosteriorSegment1');
