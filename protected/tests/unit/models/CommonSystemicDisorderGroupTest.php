 ...
 * @group disorders
 */
class CommonSystemicDisorderGroupTest extends OEDbTestCase
{
    ...
    {
        $group = CommonSystemicDisorderGroup::factory()->create();
    ...
    public function fully_qualified_name_contains_institution_short_name()
    {
        ...
        $group = CommonSystemicDisorderGroup::factory()->withInstitution($institution)->create();
