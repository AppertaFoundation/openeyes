...
class ServiceManagerTest extends \PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->manager->internal_services = array(
			'Service\\ServiceManagerTest_InternalResourceService',
			'Service\\ServiceManagerTest_InternalAmbiguousResourceService',
			'Service\\ServiceManagerTest_NonFhirResourceService',
		);
		$this->manager->init();
	}
	...
	{
		$this->assertInstanceOf('Service\\ServiceManagerTest_InternalResourceService', $this->manager->{'ServiceManagerTest_InternalResource'});
	}
	...
	{
		$this->assertInstanceOf('Service\\ServiceManagerTest_InternalResourceService', $this->manager->getService('ServiceManagerTest_InternalResource'));
	}

	/**
	 * @expectedException Service\NotFound
	...
	{
		$this->assertInstanceOf('Service\\ServiceManagerTest_InternalResourceService', $this->manager->getFhirService('FhirResourceA', array()));
	}

	/**
	 * @expectedException Service\ProcessingNotSupported
