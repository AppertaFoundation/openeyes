								...
								<?php	foreach ($episode->events as $event) {
									...
									<li id="eventLi<?php echo $event->id ?>"<?php if ($highlight) { ?> class="selected"<?php }?>>
										...
										<a href="<?php echo $event_path . $event->id ?>" data-id="<?php echo $event->id ?>">
											...
											<span class="event-date <?php echo ($event->accomplished_date != $event->created_date)?' acc_date':'' ?>"> <?php echo $event->accomplished_date? $event->NHSDateAsHTML('accomplished_date') : $event->NHSDateAsHTML('created_date'); ?></span>
										</a>
