...
echo CHtml::textField('dob_day', '', array('size'=>2));
echo '/';
echo CHtml::textField('dob_month', '', array('size'=>2));
echo '/';
echo CHtml::textField('dob_year', '', array('size'=>4));

echo '</div>';

echo '<div style="padding-left: 300px;">';
echo CHtml::label('NHS number:', 'nhs_number');
echo CHtml::textField('nhs_number');
