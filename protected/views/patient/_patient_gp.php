 ...
 */
?>
<section class="element view full view-xxx patient-info js-toggle-container">
    <header class="element-header">
        <h3 class="element-title">General Practitioner</h3>
    </header>
	<div class="element-data full-width js-toggle-body">
        <table class="standard">
            ...
            <?php if (Yii::app()->user->checkAccess('admin')) { ?>
                <tr class="data-group">
                    <td class="data-label">GP Address:</td>
                ...
                <tr class="data-group">
                    <td class="data-label">GP Telephone:</td>
