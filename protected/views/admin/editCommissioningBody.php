...
<div class="report curvybox white">
	<div class="admin">
		<h3 class="georgia"><?php echo $cb->id ? 'Edit' : 'Add'?> commissioning body</h3>
		...
		<div>
			...
			<?php echo $form->textField($cb,'name',array('size'=>'50'))?>
			<?php echo $form->textField($cb,'code',array('size'=>'10'))?>
