...
<div class="cols-5">
        ...
        <table class="standard">
            ...
            <tr>
                <th>
                    <input type="checkbox"
                           id="checkall"
                           class="co§mmissioning_body_type"/>
                </th>
                <th>Code</th>
                <th>Name</th>
            </tr>
            ...
            foreach (CommissioningBodyType::model()->findAll(array('order' => 'name asc')) as $i => $cb) { ?>
                <tr class="clickable" data-id="<?php echo $cb->id ?>"
                    data-uri="admin/editCommissioningBodyType?commissioning_body_type_id=<?php echo $cb->id ?>">
                    <td><input type="checkbox" name="commissioning_body_type[]" value="<?php echo $cb->id ?>"
                               class="wards"/></td>
            ...
            <tr>
                <td colspan="3">
                    <?= \CHtml::button(
                        ...
                        [
                            'class' => 'button large',
                            'id' => 'et_add_commissioning_body_type',
                    ...
                    <?= \CHtml::button(
                        ...
                        [
                            'class' => 'button large',
                            'name' => 'delete_commissioning_body_type',
                            'data-object' => 'commissioning_body_types',
                            'id' => 'et_delete_commissioning_body_type'
                        ]
                    ); ?>
                </td>
            </tr>
    ...
    <div id="confirm_delete_commissioning_body_types"
         title="Confirm delete commissioning_body_type" style="display: none;">
        <div>
            <div id="delete_commissioning_body_types">
                <div class="alertBox" style="margin-top: 10px; margin-bottom: 15px;">
                    <strong>WARNING: This will remove the commissioning body types from the system.<br/>This action
                ...
                <div class="buttonwrapper" style="margin-top: 15px; margin-bottom: 5px;">
                    ...
                    <button type="submit" class="classy red venti btn_remove_commissioning_body_types"><span
                                class="button-span button-span-red">Remove commissioning body types(s)</span></button>
                    <button type="submit" class="classy green venti btn_cancel_remove_commissioning_body_types"><span
