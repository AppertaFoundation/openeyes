...
<div class="report curvybox white">
	<div class="admin">
		<h3 class="georgia"><?php echo $cbt->id ? 'Edit' : 'Add'?> commissioning body type</h3>
		...
		<div>
			...
			<?php echo $form->textField($cbt,'name',array('size'=>'50'))?>
			<?php echo $form->textField($cbt,'shortname',array('size'=>'10'))?>
			<?php $this->endWidget()?>
		</div>
	</div>
</div>
