        ...
        <table class="standard">
            ...
            <?php foreach (CommissioningBody::model()->findAll(array('order' => 'name asc')) as $i => $cb) { ?>
                <tr class="clickable" data-id="<?php echo $cb->id ?>"
                    data-uri="admin/editCommissioningBody?commissioning_body_id=<?php echo $cb->id ?>">
                    <td><input type="checkbox" name="commissioning_body[]" value="<?php echo $cb->id ?>" class="wards"/>
                    </td>
        ...
        <div>
            <div id="delete_commissioning_bodies">
                <div class="alertBox" style="margin-top: 10px; margin-bottom: 15px;">
                    <strong>WARNING: This will remove the commissioning bodies from the system.<br/>This action cannot
                        be undone.</strong>
                </div>
                <p>
                ...
                <div class="buttonwrapper" style="margin-top: 15px; margin-bottom: 5px;">
                    ...
                    <button type="submit" class="classy red venti btn_remove_commissioning_bodies"><span
                                class="button-span button-span-red">Remove commissioning bodies(s)</span></button>
                    <button type="submit" class="classy green venti btn_cancel_remove_commissioning_bodies"><span
