...
<head> 
	...
	<?php Yii::app()->clientScript->registerCssFile(Yii::app()->createUrl('css/style.css'))?>
	<?php Yii::app()->clientScript->registerCssFile(Yii::app()->createUrl('css/jquery.fancybox-1.3.4.css'))?>
