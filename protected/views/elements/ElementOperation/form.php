...
?>
					...
					<?php echo $form->dropDownList($model, 'site_id', CHtml::listData(Site::model()->findAll('institution_id=:institution_id ORDER BY short_name',array(':institution_id' => 1)), 'id', 'short_name'))?>
