...
$config = array(
    ...
    'params' => array(
        ...
        */
        ...
        'oe_version' => '4.1a',
        'gp_label' => !empty(trim(getenv('OE_GP_LABEL'))) ? getenv('OE_GP_LABEL') : 'GP',
        'general_practitioner_label' => !empty(trim(getenv('OE_GENERAL_PRAC_LABEL'))) ? getenv('OE_GENERAL_PRAC_LABEL') : 'General Practitioner',
