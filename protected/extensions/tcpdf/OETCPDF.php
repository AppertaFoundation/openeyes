...
class OETCPDF extends TCPDF
{
	...
	public function Header()
	{
		if ($this->getGroupPageNo() == 1) {
			$this->Image(Yii::app()->assetManager->getPath('img/_print/letterhead_seal.jpg'), 15, 10, 25);
			$this->Image(Yii::app()->assetManager->getPath('img/_print/letterhead_Moorfields_NHS.jpg'), 95, 12, 100);
		} else {
			if ($this->rollover) {
