<div id="dropDownFieldSQLDetails<?php echo $element_num?>Field<?php echo $field_num?>">
    ...
    <div id="dropDownFieldSQLTableFieldDiv<?php echo $element_num?>Field<?php echo $field_num?>"<?php if (!@$_POST['dropDownFieldSQLTable'.$element_num.'Field'.$field_num]) {
        ...
        <div id="dropDownFieldSQLTableDefaultValueDiv<?php echo $element_num?>Field<?php echo $field_num?>"<?php if (!@$_POST['dropDownFieldSQLTableField'.$element_num.'Field'.$field_num]) {
            ?> style="display: none;"<?php
                                                     }?>>
