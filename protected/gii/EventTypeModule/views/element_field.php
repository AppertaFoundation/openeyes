<div class="element_field">
	...
	<select name="elementType<?php echo $element_num?>FieldType<?php echo $field_num?>" >
		<option value="1"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 1) {?> selected="selected"<?php }?>>Textbox</option>
		<option value="2"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 2) {?> selected="selected"<?php }?>>Textarea</option>
		<option value="3"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 3) {?> selected="selected"<?php }?>>Date picker</option>
		<option value="4"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 4) {?> selected="selected"<?php }?>>Dropdown list</option>
		<option value="5"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 5) {?> selected="selected"<?php }?>>Checkboxes</option>
		<option value="6"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 6) {?> selected="selected"<?php }?>>Radio buttons</option>
		<option value="7"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 7) {?> selected="selected"<?php }?>>Boolean</option>
		<option value="8"<?php if (@$_POST['elementType'.$element_num.'FieldType'.$field_num] == 8) {?> selected="selected"<?php }?>>EyeDraw</option>
	</select>
