<div id="radioButtonFieldSQLDetails<?php echo $element_num?>Field<?php echo $field_num?>">
    ...
    <select name="radioButtonFieldSQLTable<?php echo $element_num?>Field<?php echo $field_num?>" class="radioButtonFieldSQLTable">
        ...
        <?php foreach (Yii::app()->getDb()->getSchema()->getTableNames() as $table) {
            ?>
            <option value="<?php echo $table?>"<?php if (@$_POST['radioButtonFieldSQLTable'.$element_num.'Field'.$field_num] == $table) {
    ...
    <div id="radioButtonFieldSQLTableFieldDiv<?php echo $element_num?>Field<?php echo $field_num?>"<?php if (!@$_POST['radioButtonFieldSQLTable'.$element_num.'Field'.$field_num]) {
        ...
        <div id="radioButtonFieldSQLTableDefaultValueDiv<?php echo $element_num?>Field<?php echo $field_num?>"<?php if (!@$_POST['radioButtonFieldSQLTableField'.$element_num.'Field'.$field_num]) {
            ?> style="display: none;"<?php
                                                        }?>>
