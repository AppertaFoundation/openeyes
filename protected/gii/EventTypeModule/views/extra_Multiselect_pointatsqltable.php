<div id="multiSelectFieldSQLDetails<?php echo $element_num?>Field<?php echo $field_num?>">
    ...
    <div id="multiSelectFieldSQLTableFieldDiv<?php echo $element_num?>Field<?php echo $field_num?>"<?php if (!@$_POST['multiSelectFieldSQLTable'.$element_num.'Field'.$field_num]) {
        ...
        <div id="multiSelectFieldSQLTableDefaultValueDiv<?php echo $element_num?>Field<?php echo $field_num?>"<?php if (!@$_POST['multiSelectFieldSQLTableField'.$element_num.'Field'.$field_num]) {
            ?> style="display: none;"<?php
                                                        }?>>
