  ...
  <section class="element-fields full-width">
    <div class="row highlight-container">
      <div class="cols-6 column data-value highlight">
        ...
        <div class="row">
          <div class="cols-4 column">
            <div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('sclerostomy_type_id')) ?>:
            </div>
          </div>
          <div class="cols-8 column">
        ...
        <div class="row">
          <div class="cols-4 column">
            <div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('viscoelastic_type_id')) ?>:
            </div>
          </div>
          <div class="cols-8 column">
            <div class="data-value">
        ...
        <div class="row">
          <div class="cols-4 column">
            <div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('viscoelastic_removed')) ?>:
            </div>
          </div>
          <div class="cols-8 column">
        ...
        <div class="row">
          <div class="cols-4 column">
            <div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('viscoelastic_flow_id')) ?>:
            </div>
          </div>
          <div class="cols-8 column">
            <div class="data-value">
