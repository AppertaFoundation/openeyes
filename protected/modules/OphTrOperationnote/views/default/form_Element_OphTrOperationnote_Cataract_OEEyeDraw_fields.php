...
<?php echo $form->dropDownList($element, 'incision_site_id', 'OphTrOperationnote_IncisionSite', array('empty' => '- Please select -', 'textAttribute' => 'data-value'), false,
    array('field' => 4)) ?>
...
<?php echo $form->dropDownList($element, 'incision_type_id', 'OphTrOperationnote_IncisionType', array('empty' => '- Please select -', 'textAttribute' => 'data-value'), false,
    array('field' => 4)) ?>
<?php echo $form->textArea($element, 'report', array(), false, array('rows' => 6)) ?>
<?php echo $form->dropDownList($element, 'iol_type_id', array(
    CHtml::listData(OphTrOperationnote_IOLType::model()->activeOrPk($element->iol_type_id)->findAll(array('condition' => 'private=0', 'order' => 'display_order asc')), 'id',
        'name'),
  ...
  <div id="div_Element_OphTrOperationnote_Cataract_iol_power" class="row field-row">
    ...
    <div class="large-2 column end">
      <input id="Element_OphTrOperationnote_Cataract_iol_power" type="text" name="Element_OphTrOperationnote_Cataract[iol_power]" autocomplete="off" hide=""
    ...
    <div class="large-2 column end">
      <input id="Element_OphTrOperationnote_Cataract_predicted_refraction" type="text" name="Element_OphTrOperationnote_Cataract[predicted_refraction]" autocomplete="off"
...
<?php echo $form->multiSelectList(
    ...
    array('empty' => '- Devices -', 'label' => 'Devices'),
    false,
    false,
    null,
    false,
...
<?php echo $form->multiSelectList(
    ...
    'id',
    CHtml::listData(
        OphTrOperationnote_CataractComplications::model()->activeOrPk($element->cataractComplicationValues)
            ->findAll(
