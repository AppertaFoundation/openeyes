...
<div class="box admin">
    <h2>Per Op Instructions</h2>

    <table class="generic-admin sortable">
        <thead>
        <tr>
<!--                <th>Order</th>-->
            <th>Content</th>
    ...
    <div>
        <button class="small secondary primary event-action" name="admin-add" type="button" id="add_new">Add</button>&nbsp;
    </div>
