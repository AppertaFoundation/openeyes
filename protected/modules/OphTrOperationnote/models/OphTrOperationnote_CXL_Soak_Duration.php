 ...
 *
 * The followings are the available columns in table 'ophtroperationnote_cxl_soak_duration':
 *
 * @property string $id
 * @property int $name
 ...
 *
 */
class OphTrOperationnote_CXL_Soak_Duration extends BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophtroperationnote_cxl_soak_duration';
    }
