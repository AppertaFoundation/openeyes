 ...
 *
 * The followings are the available columns in table 'ophtroperationnote_cxl_uv_irradiance':
 *
 * @property string $id
 * @property int $name
 ...
 *
 */
class OphTrOperationnote_CXL_UV_Irradiance_Range extends BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophtroperationnote_cxl_uv_irradiance';
    }
