 ...
 *
 * The followings are the available columns in table 'ophtroperationnote_cxl_devices':
 *
 * @property string $id
 * @property int $name
 ...
 *
 */
class OphTrOperationnote_CXL_Device extends BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophtroperationnote_cxl_devices';
    }
