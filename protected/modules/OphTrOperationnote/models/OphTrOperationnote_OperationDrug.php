 ...
 *
 * @property string $id
 * @property int $et_ophtroperationnote_postop_drugs_id
 * @property int $drug_id
 */
class OphTrOperationnote_OperationDrug extends BaseActiveRecordVersioned
{
    /**
     * Returns the static model of the specified AR class.
     *
     * @return OphTrOperationnote_OperationDrug the static model class
     */
    ...
    {
        return 'ophtroperationnote_postop_drugs_drug';
    }
