 ...
 *
 * The followings are the available columns in table 'ophtroperationnote_cxl_protocol':
 *
 * @property string $id
 * @property int $name
 ...
 *
 */
class OphTrOperationnote_CXL_Protocol extends BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophtroperationnote_cxl_protocol';
    }
