...
{
    private static $short_codes_for_op_note = array(
        array('code' => 'lod', 'method' => 'getLastOperationDate', 'description' => 'Last Operation Date'),
        array('code' => 'los', 'method' => 'getLastOperationSurgeonName', 'description' => 'Last Operation Surgeon Name'),
        array('code' => 'lol', 'method' => 'getLastOperationLocation', 'description' => 'Last Operation Location'),
        array('code' => 'opm', 'method' => 'getLastOperationIncisionMeridian', 'description' => 'Last Operation Incision Meridian'),
        array('code' => 'rxp', 'method' => 'getLastOperationPredictedRefraction', 'description' => 'Last Operation Predicted Refraction'),
