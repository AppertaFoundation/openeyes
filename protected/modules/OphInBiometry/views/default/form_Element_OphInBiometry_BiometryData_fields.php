...
<div class="element-fields">
	<div id="div_Element_OphInBiometry_BiometryData_axial_length_<?php echo $side?>" class="row">
	...
	<div id="div_Element_OphInBiometry_BiometryData_r1_<?php echo $side?>" class="row">
		<div class="cols-3 column">
	...
	<div id="div_Element_OphInBiometry_BiometryData_r2_<?php echo $side?>" class="row">
		<div class="cols-3 column">
	...
	<div id="div_Element_OphInBiometry_BiometryData_rse_<?php echo $side?>" class="row">
		<div class="cols-3 column">
	...
	<div id="div_Element_OphInBiometry_BiometryData_cyl_<?php echo $side?>" class="row">
		<div class="cols-3 column">
