...
class LaserModule extends OpenEyesPage
{
    ...
    protected $elements = array(
        ...
        'removeRightEye' => array('xpath' => "//*[@class='js-element-eye right-eye column left']//a[contains(text(),'Remove eye')]"),
        'addRightEye' => array('xpath' => "//*[@class='js-element-eye right-eye column left inactive']//a[contains(text(),'Add right side')]"),
