    ...
    <div class="admin box">
        ...
        <div class="large-3 column">
            <?php if( $this->checkAccess('TaskEditGeneticPatient') && isset($_GET['patient']) && $_GET['patient']): ?>
                <?php
                    $link = '/Genetics/subject/edit';

                    if( isset($_GET['genetics_patient_id']) ){
                        $link .= '/' . $_GET['genetics_patient_id'];
                    } else {
                ...
                $params['pedigree_id'] = $model->id;

                $link .= '?' . http_build_query($params);

                ?>

                <a href="<?=$link ?>" class="button small right secondary">Back to Genetics Patient</a>
            <?php endif; ?>
