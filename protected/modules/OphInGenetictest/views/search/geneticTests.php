              ...
              <tr>
                ...
                <td>
                    <?php echo CHtml::dropDownList('method-id', @$_GET['method-id'],
                        CHtml::listData(OphInGenetictest_Test_Method::model()->findAll(array('order' => 'name asc')), 'id', 'name'), array('empty' => '- All -')) ?>
                </td>
                <td>
                ...
                <td>
                    <?php echo CHtml::dropDownList('effect-id', @$_GET['effect-id'],
                        CHtml::listData(OphInGenetictest_Test_Effect::model()->findAll(array('order' => 'name asc')), 'id', 'name'), array('empty' => '- All -')) ?>
                </td>
              </tr>
              </tbody>
            </table>
