...
class AdminEpisodeStatusController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('EpisodeStatus', array(
	...
	{
		$model=new EpisodeStatus('search');
		$model->unsetAttributes();	// clear any default values
		if(isset($_GET['EpisodeStatus']))
			$model->attributes=$_GET['EpisodeStatus'];
