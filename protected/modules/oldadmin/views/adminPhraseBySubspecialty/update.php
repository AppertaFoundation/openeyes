...
$this->menu=array(
	...
	array('label'=>'View PhraseBySubspecialty', 'url'=>array('view', 'id'=>$model->id)),
	array('label'=>'Manage PhraseBySubspecialty', 'url'=>array('admin')),
);
?>

<h1>Update PhraseBySubspecialty <?php echo $model->id; ?></h1>
