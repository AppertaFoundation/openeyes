...
return array(
    ...
    'params' => array(
        ...
        'admin_menu' => array(
            'PatientTicketing' => [
                'Clinic locations' => '/PatientTicketing/PatientTicketingAdmin/ClinicLocations/index',
                'Queue Set Categories' => '/PatientTicketing/admin/queueSetCategories',
                'Queue Sets' => '/PatientTicketing/admin/',
                'Outcome Options' => '/PatientTicketing/PatientTicketingAdmin/OutcomeOptions/index',
            ]
        ),
