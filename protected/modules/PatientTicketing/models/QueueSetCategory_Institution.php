...
class QueueSetCategory_Institution extends BaseActiveRecordVersioned
{
    ...
    {
        return 'patientticketing_queuesetcategory_institution';
    }
    ...
    {
        return array(
            array('institution_id, category_id', 'required'),
        );
    }
    ...
    public function relations()
    {
        return array(
            ...
            'queueset_category' => array(self::BELONGS_TO, QueueSetCategory::class, 'category_id'),
        );
    }
}
