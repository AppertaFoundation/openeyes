...
use OEModule\PatientTicketing\models\QueueSet_Institution;
use OEModule\PatientTicketing\models\QueueSetCategory;

class QueueSetFactory extends ModelFactory
{
    public function definition(): array
    {
        return [
            ...
            'initial_queue_id' => Queue::factory(),
        ];
    }
    ...
    {
        return $this->afterCreating(function (QueueSet $queueset) use ($institution) {
            ModelFactory::factoryFor(QueueSet_Institution::class)
                ->forQueueSet($queueset)
