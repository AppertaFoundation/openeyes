...
class m200429_045731_create_theatreadmissions_checklist_question_table extends OEMigration
{
    private $questions_admissions_elements_array = array(
        'Admission' => array(
            array(
                'id' => 1,
            ...
            array(
                'id' => 2,
                'question' => 'Are there any change to the patient\'s medication?',
                'type' => 'RADIO',
                'mandatory' => 1,
                'is_comment_field_required' => 1,
                'display_order' => 20
            ...
            array(
                'id' => 10,
                'question' => 'Anti-embolic stocking required',
                'type' => 'RADIO',
                'mandatory' => 1,
                'is_comment_field_required' => 1,
                'display_order' => 100
            ...
            array(
                'id' => 13,
                'question' => 'Covid 19 Swab Results',
                'type' => 'RADIO',
                'mandatory' => 0,
                'is_comment_field_required' => 1,
                'display_order' => 130
        ...
        'Documentation' => array(
            ...
            array(
                'id' => 18,
                'question' => 'Correct sign surgery form signed',
                'type' => 'RADIO',
                'mandatory' => null,
                'is_comment_field_required' => 1,
                'display_order' => 170
        ...
        'Nursing/Practitioner Assessment' => array(
            ...
            array(
                'id' => 37,
                'question' => 'Caps/Crows/Loose teeth',
                'type' => 'RADIO',
                'mandatory' => null,
                'is_comment_field_required' => 1,
                'display_order' => 260
        ...
        'DVT' => array(
            array(
                'id' => 40,
                'question' => 'Anti-embolic stockings DVT prophylaxis',
                'type' => 'RADIO',
                'mandatory' => null,
                'is_comment_field_required' => 1,
                'display_order' => 290
        ...
        'Patient Support' => array(
            ...
            array(
                'id' => 43,
                'question' => 'Accompanied to theatre By',
                'type' => 'RADIO',
                'mandatory' => null,
                'is_comment_field_required' => 1,
                'display_order' => 320
        ...
        'Discharge' => array(
            ...
            array(
                'id' => 45,
                'question' => 'Return from Theatre Date and Theatre Time',
                'type' => 'DATETIME',
                'mandatory' => null,
                'is_hidden' => 1,
                'is_comment_field_required' => 0,
            ...
            array(
                'id' => 59,
                'question' => 'Outpatient appointment given for:',
                'type' => 'DATETIME',
                'mandatory' => null,
                'is_hidden' => 1,
                'is_comment_field_required' => 0,
            ...
            array(
                'id' => 60,
                'question' => 'To be posted for (weeks):',
                'type' => 'TEXT',
                'mandatory' => null,
                'is_hidden' => 1,
                'is_comment_field_required' => 0,
    ...
    private $questionSections = array(
        array(
            'question_id' => 12,
            'section_name' => 'OphCiTheatreadmission_Dilation',
        ),
        array(
            'question_id' => 14,
            'section_name' => 'OphCiTheatreadmission_Observations',
        ),
    );
    ...
    {
        // Creating Table
        $this->createOETable('ophcitheatreadmission_checklist_questions', array(
            'id' => 'pk',
            'element_type_id' => 'int(10) unsigned',
            'question' => 'text NOT NULL',
            'type' => 'enum("TEXT", "RADIO", "DROPDOWN", "DATETIME", "SECTION") DEFAULT NULL COMMENT "type of response"',
        ...
        // Add Foreign Key
        $this->addForeignKey(
            'ophcitheatreadmission_cq_etid_fk',
        ...
        try {
            ...
            // the values in the "ophcitheatreadmission_checklist_question_relationships" table the question_id.
            foreach ($this->questions_admissions_elements_array as $element_name => $questions_admissions_elements) {
                $element_id = $this->dbConnection->createCommand()
                    ->select('id')
                    ->from('element_type')
                    ->where('name=:name', array(':name' => $element_name))
                    ->queryRow();
                foreach ($questions_admissions_elements as $questions_admissions_element) {
                    $questions_admissions_element['element_type_id'] = $element_id['id'];
                    $this->insert('ophcitheatreadmission_checklist_questions', $questions_admissions_element);
                }
            }
            $transaction->commit();
        } catch (Exception $e) {
    ...
    {
        $this->dropForeignKey(
            'ophcitheatreadmission_cqr_sqid_fk',
            'ophcitheatreadmission_checklist_question_relationships'
        );
        $this->dropForeignKey(
            'ophcitheatreadmission_cqr_pqid_fk',
            'ophcitheatreadmission_checklist_question_relationships'
        );
        $this->dropOETable('ophcitheatreadmission_checklist_question_section', true);
        $this->dropOETable('ophcitheatreadmission_checklist_question_relationships', true);
        $this->dropOETable('ophcitheatreadmission_checklist_questions', true);
    }

    private function createQuestionRelationshipsTable()
    {
        // Creating Table
        $this->createOETable('ophcitheatreadmission_checklist_question_relationships', array(
            'id' => 'pk',
    ...
    private function populateQuestionRelationsTable()
    {
        ...
        foreach ($this->questionRelationships as $questionRelationship) {
            $this->insert('ophcitheatreadmission_checklist_question_relationships', $questionRelationship);
        }
    }
    ...
    private function createSectionTable()
    {
        ...
        $this->createOETable('ophcitheatreadmission_checklist_question_section', array(
            'id' => 'pk',
            'question_id' => 'int(11)',
            'section_name' => 'text',
        ), true);
        ...
        // Add Foreign Key
        $this->addForeignKey(
            'ophcitheatreadmission_checklist_qs_qid_fk',
            'ophcitheatreadmission_checklist_question_section',
            'question_id',
            'ophcitheatreadmission_checklist_questions',
            'id'
        );
    ...
    private function populateQuestionSectionsTable()
    {
        ...
        foreach ($this->questionSections as $questionSection) {
            $this->insert('ophcitheatreadmission_checklist_question_section', $questionSection);
        }
    }
}
