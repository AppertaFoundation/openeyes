...
class m200630_080421_create_theatre_admission_element_set_item_table extends OEMigration
{
    public function up()
    {
        $this->createOETable('ophcitheatreadmission_element_set_item', array(
            'id' => 'pk',
            'set_id' => 'int(11)',
        ...
        // Add Foreign Key
        $this->addForeignKey(
            'ophcitheatreadmission_esi_sid_fk',
            'ophcitheatreadmission_element_set_item',
            'set_id',
        ...
        $this->addForeignKey(
            'ophcitheatreadmission_esi_etid_fk',
            'ophcitheatreadmission_element_set_item',
            'element_type_id',
            'element_type',
            'id'
        ...
        $element_set_items_array[] = $this->createElementSetArray(['Procedure List', 'Admission', 'Case Notes'], 1, $display_order)[0];
        ...
        foreach ($element_set_items_array as $element_set_items) {
            foreach ($element_set_items as $element_set_item) {
                $this->insert('ophcitheatreadmission_element_set_item', $element_set_item);
            }
        }
    }
    ...
    {
        $this->dropOETable('ophcitheatreadmission_element_set_item', true);
    }
}
