...
/**
 * @var OphCiTheatreadmission_Observations $name_stub
 */
?>
<td></td>
<tr class="no-line">
...
<tr class="no-line">
    ...
    <td>
        <span class="data-label"><?= $element->getAttributeLabel('inr') ?>:</span>
    </td>
    <td>
        <span class="data-value"><?php echo (!empty($element->inr)) ? $element->inr : '' ?></span>
    </td>
</tr>
