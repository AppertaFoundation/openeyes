...
$results = Yii::app()->db->createCommand()
    ...
    ->from('ophcitheatreadmission_nursing_checklist_results')
...
<?php if (isset($results)) {
    foreach ($results as $result) {
        if ($result['count'] > 0) {
            ...
            $element1 = Element_OphCiTheatreadmission_NursingAssessment::model()
            ...
            if (isset($element1)) {
                ...
                $this->renderPartial('checklist_view', array(
                        ...
                        'resultModel' => OphCiTheatreadmission_NursingChecklistResults::model(),
