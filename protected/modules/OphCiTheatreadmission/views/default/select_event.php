...
?>
        ...
        <header class="element-header">
            <h3 class="element-title">Create Theatre Admission</h3>
        </header>
            ...
            <div class="data-value flex-layout">
                <p>
                    <?php if (count($operations) > 0) : ?>
                        Please indicate whether this theatre admission relates to a booking or an unbooked emergency:
                    <?php else : ?>
                        There are no open bookings in the current episode so only an emergency theatre admission can be created.
                    <?php endif; ?>
                </p>
            </div>
            <br/>
...
<script type="text/javascript">
    ...
    function selectBooking(booking) {
        ...
        $('#theatre-admission-select').submit();
    }
