...
/**
 * @var Element_OphCiTheatreadmission_Documentation $element
 */
?>
<?php
$results = Yii::app()->db->createCommand()
    ->select('count(*) as count, set_id')
    ->from('ophcitheatreadmission_documentation_checklist_results')
...
<?php if (isset($results)) {
    foreach ($results as $result) {
        if ($result['count'] > 0) {
            ...
            $element1 = Element_OphCiTheatreadmission_Documentation::model()
            ...
            if (isset($element1)) {
                ...
                $this->renderPartial('checklist_view', array(
                        ...
                        'resultModel' => OphCiTheatreadmission_DocumentationChecklistResults::model(),
