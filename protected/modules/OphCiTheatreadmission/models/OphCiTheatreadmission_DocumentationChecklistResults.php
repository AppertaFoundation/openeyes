...
/**
 * This is the model class for table "ophcitheatreadmission_documentation_checklist_results".
 *
 * The followings are the available columns in table 'ophcitheatreadmission_documentation_checklist_results':
 * @property integer $id
 ...
 * @property Element_OphCiTheatreadmission_Documentation $element
 * @property OphcitheatreadmissionChecklistQuestions $question
 * @property User $createdUser
 * @property User $lastModifiedUser
 */
class OphCiTheatreadmission_DocumentationChecklistResults extends CActiveRecord
{
    /**
    ...
    {
        return 'ophcitheatreadmission_documentation_checklist_results';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'element' => array(self::BELONGS_TO, 'Element_OphCiTheatreadmission_Documentation', 'element_id'),
     ...
     * @return OphCiTheatreadmission_DocumentationChecklistResults the static model class
     */
