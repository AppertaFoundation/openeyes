...
/**
 * This is the model class for table "ophcitheatreadmission_observations".
 *
 * The followings are the available columns in table 'ophcitheatreadmission_observations':
 * @property integer $id
 ...
 */
class OphCiTheatreadmission_Observations extends \BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophcitheatreadmission_observations';
    }
    ...
    public function rules()
    {
        ...
        return array(
            array('blood_pressure_systolic, blood_pressure_diastolic, pulse, temperature, respiration, o2_sat, ews, blood_glucose, hba1c, inr', 'required'),
            array('inr', 'numerical', 'integerOnly'=>true),
            array('checklist_result_id, last_modified_user_id, created_user_id', 'length', 'max'=>10),
            array('blood_pressure_systolic, blood_pressure_diastolic, pulse, temperature, respiration, o2_sat, ews', 'length', 'max'=>3),
            array('blood_glucose, hba1c', 'length', 'max'=>4),
            array('last_modified_date, checklist_result_id, created_date', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, checklist_result_id, blood_pressure_systolic, blood_pressure_diastolic, pulse, temperature, respiration, o2_sat, ews, blood_glucose, hba1c, inr, last_modified_user_id, last_modified_date, created_user_id, created_date', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'checklistResults' => array(self::BELONGS_TO, 'OphcitheatreadmissionAdmissionChecklistResults', 'checklist_result_id'),
        );
    }
     ...
     * @return OphCiTheatreadmission_Observations the static model class
     */
