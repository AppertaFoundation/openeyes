...
/**
 * This is the model class for table "ophcitheatreadmission_patient_support_checklist_results".
 *
 * The followings are the available columns in table 'ophcitheatreadmission_patient_support_checklist_results':
 * @property integer $id
 ...
 * @property Element_OphCiTheatreadmission_PatientSupport $element
 * @property OphCiTheatreadmission_ElementSet $set
 * @property OphcitheatreadmissionChecklistQuestions $question
 */
class OphCiTheatreadmission_PatientSupportChecklistResults extends CActiveRecord
{
    /**
    ...
    {
        return 'ophcitheatreadmission_patient_support_checklist_results';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'element' => array(self::BELONGS_TO, 'Element_OphCiTheatreadmission_PatientSupport', 'element_id'),
     ...
     * @return OphCiTheatreadmission_PatientSupportChecklistResults the static model class
     */
