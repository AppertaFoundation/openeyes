...
/**
 * This is the model class for table "ophcitheatreadmission_element_set_item".
 *
 * The followings are the available columns in table 'ophcitheatreadmission_element_set_item':
 * @property integer $id
 ...
 */
class OphCiTheatreadmission_ElementSetItem extends CActiveRecord
{
    /**
    ...
    {
        return 'ophcitheatreadmission_element_set_item';
    }
     ...
     * @return OphCiTheatreadmission_ElementSetItem the static model class
     */
