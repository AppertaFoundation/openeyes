...
/**
 * This is the model class for table "ophcitheatreadmission_nursing_checklist_results".
 *
 * The followings are the available columns in table 'ophcitheatreadmission_nursing_checklist_results':
 * @property integer $id
 ...
 * @property Element_OphCiTheatreadmission_NursingAssessment $element
 * @property OphCiTheatreadmission_ElementSet $set
 * @property OphcitheatreadmissionChecklistQuestions $question
 * @property User $createdUser
 * @property User $lastModifiedUser
 */
class OphCiTheatreadmission_NursingChecklistResults extends CActiveRecord
{
    /**
    ...
    {
        return 'ophcitheatreadmission_nursing_checklist_results';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'element' => array(self::BELONGS_TO, 'Element_OphCiTheatreadmission_NursingAssessment', 'element_id'),
     ...
     * @return OphCiTheatreadmission_NursingChecklistResults the static model class
     */
