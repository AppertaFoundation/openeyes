...
class m160815_113951_patient_factor_data extends CDbMigration
{
    ...
    public function up()
    {
        ...
        $this->insert('ophcocvi_clinicinfo_patient_factor', array('name' => 'In the case of a child, would the parent/s or guardian/s welcome guidance about child development, schooling, social implications or parenting?', 'code' => 'PF1', 'display_order' => 9));
    }
