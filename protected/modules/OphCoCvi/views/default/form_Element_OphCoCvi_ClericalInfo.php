          ...
          <tr>
            ...
            <td>
                <?php echo $form->dropDownList($element, 'preferred_info_fmt_id',
                    CHtml::listData(OEModule\OphCoCvi\models\OphCoCvi_ClericalInfo_PreferredInfoFmt::model()->findAll(
                ...
                ?>
              <div class="cols-6">
                  <?php echo $form->textField($element, 'info_email', array('size' => '20'), false,
      ...
      <div class="cols-6 data-group">
        <table class="cols-full last-left">
          ...
          <tr>
            ...
            <td>
                <?php echo $form->textArea($element, 'social_service_comments', array('nowrapper' => true), false,
                    array()) ?>
            </td>
          </tr>
          </tbody>
