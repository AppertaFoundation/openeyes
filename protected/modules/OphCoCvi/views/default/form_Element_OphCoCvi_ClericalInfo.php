...
?>
    ...
    <div class="element-fields row">
        <div class="indent-correct row">
            ...
            <div class="large-6 column end">
                <?php echo $form->dropDownList($element, 'preferred_language_id', array('0'=>'OTHER') + CHtml::listData(Language::model()->findAll(array('order' => 'name asc')), 'id', 'name'), array(), false, array('label' => 6, 'field' => 6)) ?>
