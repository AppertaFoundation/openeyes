...
class LetterMacro_Institution extends BaseActiveRecordVersioned
{
    ...
    {
        return 'ophcocorrespondence_letter_macro_institution';
    }

    public function rules()
    {
        return [
            ['id, letter_macro_id, institution_id', 'safe'],
            ['id, letter_macro_id, institution_id', 'safe', 'on' => 'search'],
        ];
    }
