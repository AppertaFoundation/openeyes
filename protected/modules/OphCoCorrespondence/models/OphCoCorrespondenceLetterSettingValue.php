...
/**
 * This is the model class for table "setting_internal_referral".
 *
 * The followings are the available columns in table 'setting_internal_referral':
 * @property string $id
 ...
 */
class OphCoCorrespondenceLetterSettingValue extends CActiveRecord
{
    /**
    ...
    {
        return 'ophcocorrespondence_letter_setting_value';
    }
     ...
     * @return SettingInternalReferral the static model class
     */
