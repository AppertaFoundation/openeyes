...
<div class="box admin">
    ...
    $form = $this->beginWidget('BaseEventTypeCActiveForm', array(
        ...
        <?php echo $form->radioButtons($macro, 'recipient_id',
            CHtml::listData(LetterRecipient::model()->findAll(array('order' => 'display_order asc')), 'id', 'name') + ['0' => 'None'],
            (!$macro->recipient_id ? '0' : null), false, false, false, false, array('empty' => 'None', 'empty-after' => true))
