...
<div class="box admin">
  <h2>Edit macro</h2>
    ...
    <?php echo $form->radioButtons($macro, 'recipient_id', $recipients_data + $none_option,
        (!$macro->recipient_id ? '0' : null), false, false, false, false,
  ...
  <div class="cols-8 large-offset-2 column">
    <div class="data-group">
      ...
      <div class="cols-6 column end">
          <?php echo CHtml::dropDownList('shortcode', '',
              CHtml::listData(PatientShortcode::model()->findAll(array('order' => 'description asc')), 'code',
