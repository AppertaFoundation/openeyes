...
<div class="box admin">
    ...
    $form = $this->beginWidget('BaseEventTypeCActiveForm', array(
        ...
        <?php echo $form->dropDownList($macro, 'letter_type_id', CHtml::listData(LetterType::model()->findAll(array('condition' => 'is_active = 1', 'order' => 'name asc')), 'id', 'name'), array('empty' => '- Letter type -'))?>
