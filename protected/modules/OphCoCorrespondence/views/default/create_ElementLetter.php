...
<div class="element-fields full-width flex-layout flex-top col-gap">
        ...
        <div class="data-group">
          <table class="cols-full">
            ...
            <tr>
              ...
              <td>
                  <?php echo $form->textArea($element, 're', array('rows' => 2, 'label' => false, 'nowrapper' => true),
                      false, array('class' => 'address')) ?>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                  <?php echo $form->textArea($element, 'body', array('rows' => 20, 'label' => false, 'nowrapper' => true),
                      false, array('class' => 'address')) ?>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <div id="enclosureItems"
                     class="<?php echo !is_array(@$_POST['EnclosureItems']) ? ' hide' : ''; ?>">
  ...
  <div class="data-group">
    ...
    <div class="cols-<?php echo $layoutColumns['field']; ?> column end">
        <?php echo $form->hiddenField($element, 'cc', array('rows' => 8, 'label' => false, 'nowrapper' => true), false,
            array('class' => 'address')) ?>
    </div>
    <div id="cc_targets">
