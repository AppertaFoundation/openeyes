...
<?php } else { if (Yii::app()->params['nhs_num_private'] == true) { ?>Hosp No: <?php echo $element->event->episode->patient->hos_num?><?php } else {?>Hosp No: <?php echo $element->event->episode->patient->hos_num?>, <?php echo Yii::app()->params['nhs_num_label']?> No: <?php echo $element->event->episode->patient->nhsnum?> <?php }}?></strong></p>
