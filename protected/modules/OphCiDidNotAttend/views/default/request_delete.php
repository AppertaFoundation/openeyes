...
?>
    ...
    <?=\CHtml::form(array('Default/requestDeletion/'.$this->event->id), 'post', array('id' => 'deleteForm'))?>    <div id="delete_event">
        ...
        <?=\CHtml::hiddenField('event_id', $this->event->id)?>        <button type="submit" class="warning" id="et_deleteevent" name="et_deleteevent">
            Request deletion
        </button>
