...
/**
 * This is the model class for table "ophcotherapya_relevanttreatment".
 *
 * These are treatments that are selectable in exceptional circumstances / related treatments.
 *
 * @property integer $id The tree id
 * @property string $name The name of the treatment.
 * @property integer $display_order The order index for displaying the treatment.
 *
 **/
...
class OphCoTherapyapplication_RelevantTreatment extends BaseActiveRecordVersioned
{
	...
	{
		return 'ophcotherapya_relevanttreatment';
	}
