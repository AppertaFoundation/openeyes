...
<div class="panel previous-interventions pastintervention" data-key="<?php echo $key ?>">
	<a href="#" class="icon-remove-side removePastintervention removeElementForm">Remove</a>
