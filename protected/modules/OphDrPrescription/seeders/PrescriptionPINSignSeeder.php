...
/**
* PrescriptionPINSignSeeder is a seeder for generating data used solely in the 'Prescription PIN sign setting' test (prescription\13352-prescription-PIN-sign-setting-toggle.cy.js)
*/
class PrescriptionPINSignSeeder extends BaseSeeder
{
    /**
