                ...
                <tr>
                    <td colspan="<?php echo count($admin->getListFields()) + 1; ?>">
                        <?php if (isset($buttons) && ($buttons == true)) { ?>
                            <button class="button large js-choose-option" type="button">Add</button>
                            <?=\CHtml::button(
                                'Delete',
                                [
                                    'class' => 'button large',
    ...
    $('.js-choose-option').click(function (e) {
        ...
        var dialog = new OpenEyes.UI.Dialog({
         ...
         dialog.on('open', function() {
             ...
             $(".choose-option-list").chosen({width: "40%"});
             $('input:radio').change(function(){
                 if ($(this).val() === '1') {
                     $('.choose-option-list-box').css('display', 'none');
                 } else if ($(this).val() === '2') {
                     $('.choose-option-list-box').css('display', 'block');
                 }
             });
