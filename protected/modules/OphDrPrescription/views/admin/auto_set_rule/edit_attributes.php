...
<script id="row_template" type="x-tmpl-mustache">
    <tr data-key="{{ key }}">
        <td>
            ...
            <input class="js-attribute" type="hidden" name="MedicationSet[attribute][medication_attribute_id][]" value="{{attribute_id}}" />
            {{attribute_name}}
        </td>
        <td>
            <input class="js-option" type="hidden" name="MedicationSet[attribute][medication_attribute_option_id][]" value={{option_id}} />
            {{option_name}}
        </td>
        <td>
    ...
    <?php foreach ($medicationSet->medicationAutoRuleAttributes as $assignment): ?>
        ...
        <tr data-key="<?=$rowkey?>">
            <td>
                ...
                <input type="hidden" name="MedicationSet[attribute][medication_attribute_id][]" value="<?=$attr_id?>" />
				<?php echo CHtml::encode($attr_name); ?>
            </td>
            <td>
                <input type="hidden" name="MedicationSet[attribute][medication_attribute_option_id][]" value="<?=$option_id?>" />
