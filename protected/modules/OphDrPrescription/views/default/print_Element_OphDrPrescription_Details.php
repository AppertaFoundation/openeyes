                    ...
                    <div id="<?= $form_css_class ?>-prescription-list" class="fpten-form-column">
                        <?php
                            ...
                            for ($j = $current_item_index; $j < $total_items; $j++) {
                                ...
                                $current_item_copy = $current_item_index ?: $current_item_copy;
                                $current_attr_copy = $current_item_attr ?: $current_attr_copy;
                                $current_taper_copy = $current_taper_index ?: $current_taper_copy;
                                ...
                                if ($item->fpTenLinesUsed() + 1 > MAX_FPTEN_LINES - $prescription_lines_used && !$split_print) {
                                    ...
                                    if ($i === 0 && $j === 0 && $split_print && $side === 'left') {
                        ...
                        <div class="fpten-prescription-item fpten-form-row">
                            <?php
                                    ...
                                    if ($split_print && $side === 'right') {
                                        $split_print = false;
                                        $split_print_end = false;
                                    } else if ($split_print && $side === 'left' && $i !== 0) {
                            ...
                            <div class="fpten-prescription-list-filler fpten-form-row">
                                ...
                                if (!$split_print && $split_print_end && $side === 'left') {
                                    $current_item_attr = $current_attr_copy;
                                    $current_item_index = $current_item_copy;
                                    $split_print = true;
                                    $split_print_end = false;
                                }?>
                            </div>
