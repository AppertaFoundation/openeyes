...
class m180809_053651_update_existing_tapers extends CDbMigration
{
	public function up()
	{
	    ...
	    try {
            ...
            $this->execute("ALTER TABLE ophdrprescription_item_taper MODIFY duration_id INT(11) NOT NULL");
			...
			$this->addForeignKey('ophdrprescription_item_taper_duration_id_fk',
				'ophdrprescription_item_taper',
				'duration_id','medication_duration', 'id');
	...
	public function down()
	{
        ...
        try {
            ...
            $this->addForeignKey('ophdrprescription_item_taper_frequency_id_fk',
                'ophdrprescription_item_taper',
                'frequency_id','drug_frequency', 'id');

			$this->addForeignKey('ophdrprescription_item_taper_duration_id_fk',
				'ophdrprescription_item_taper',
				'duration_id','drug_duration', 'id');
