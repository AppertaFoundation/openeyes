...
<script id="row_template" type="x-tmpl-mustache">
    <tr data-key="{{ key }}">
        <td>
            <input class="js-attribute" type="hidden" name="MedicationAttributeAssignment[{{key}}][medication_id]" value="{{attribute_id}}" />
            {{attribute_name}}
        </td>
        <td>
            <input class="js-option" type="hidden" name="MedicationAttributeAssignment[{{key}}][medication_attribute_option_id]" value={{option_id}} />
            {{option_name}}
        </td>
        <td>
...
<table class="standard" id="medication_attribute_assignment_tbl">
    ...
    <?php foreach ($medication->medicationAttributeAssignments as $rowkey => $assignment) : ?>
        ...
        <tr data-key="<?=$rowkey?>">
            <td>
                <input type="hidden" name="MedicationAttributeAssignment[<?=$rowkey?>][id]" value="<?=$assignment->id?>" />
                <input type="hidden" name="MedicationAttributeAssignment[<?=$rowkey?>][medication_id]" value="<?=$attr_id?>" />
                <?= CHtml::encode($attr_name); ?>
            </td>
            <td>
                <input type="hidden" name="MedicationAttributeAssignment[<?=$rowkey?>][medication_attribute_option_id]" value="<?=$option_id?>" />
