 ...
 */
/**
 * This is the model class for table "ophdrprescription_signature".
 *
 * The followings are the available columns in table 'ophdrprescription_signature':
 * @property integer $id
 ...
 * @property Element_OphDrPrescription_Esign $element
...
class OphDrPrescription_Signature extends BaseSignature
{
    ...
    {
        if ($this->type !== self::TYPE_OTHER_USER && is_null($this->signature_file_id)) {
    ...
    public function relations()
    {
        ...
        return array(
            'element' => array(self::BELONGS_TO, Element_OphDrPrescription_Esign::class, 'element_id'),
     ...
     * @return OphDrPresciption_Signature the static model class
     */
    ...
    {
        if ($this->type === self::TYPE_OTHER_USER) {
    ...
    public function deletePreviousSignature()
    {
        ...
        $criteria->params = array(':element_id' => $this->element_id);
        $criteria->limit = 1;
