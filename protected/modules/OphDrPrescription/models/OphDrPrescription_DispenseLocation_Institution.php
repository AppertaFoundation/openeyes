...
class OphDrPrescription_DispenseLocation_Institution extends BaseActiveRecordVersioned
{
    ...
    {
        return 'ophdrprescription_dispense_location_institution';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'dispense_condition_institutions' => array(self::MANY_MANY, 'OphDrPrescription_DispenseCondition_Institution', 'ophdrprescription_dispense_condition_assignment(dispense_location_institution_id, dispense_condition_institution_id)'),
     ...
     * @return OphDrPrescription_DispenseLocation_Institution the static model class
     */
