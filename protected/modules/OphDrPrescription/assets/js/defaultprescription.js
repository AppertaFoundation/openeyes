...
$(document).ready(function() {
    ...
    if(show_warning && error_count == 0)
    {
       ...
       // alert ('L->'+position.left+ ' T '+position.top);
        ...
        var dialog_msg = '<div class="ui-dialog ui-widget ui-widget-content ui-corner-all dialog" id="dialog-msg" tabindex="-1" role="dialog" aria-labelledby="ui-id-1" style="outline: 0px; z-index: 10002; height: auto; width: 600px;  margin-left: 725px; margin-top: 375px; ">' +
