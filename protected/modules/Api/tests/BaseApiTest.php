...
namespace OEModule\Api\tests;

use GuzzleHttp\Client;
use OE\factories\models\UserAuthenticationFactory;
use User;

abstract class BaseApiTest extends \RestTestCase
{
    /**
     * @var Client
     */
    ...
    protected string $base_url = 'http://localhost/Api/';
    ...
    public function setUp(): void
    {
        ...
        $this->client = new Client(
            [
                'base_uri' => $this->base_url . $this->base_url_stub,
