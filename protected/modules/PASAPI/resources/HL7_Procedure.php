...
class HL7_Procedure extends BaseHL7_Section
{
    ...
    {
        $this->procedure_code_identifier = $entry->investigationCode->name;
        ...
        $this->procedure_code_text = $comment;
    ...
    {
        $this->procedure_code_identifier = $entry->procedure->term;
        if (!empty($entry->procedure)) {
            $this->procedure_code_name_of_coding_system = "ECDS";
        } else {
            $this->procedure_code_name_of_coding_system = "SNOMED";
        }
        $this->procedure_code_text = "";
    ...
    function getHL7attributes()
    {
        $attributes = array(
            ...
            $this->prefix.'.5' => $this->procedure_date_time,
