 ...
 */
class GP extends BaseResource
{
    protected static $resource_type = 'GP';
    protected static $model_class = 'Gp';
    ...
    public function save()
    {
        ...
        try {
            if ($this->saveModel($model)) {
                ...
                $this->audit($this->isNewResource ? 'create' : 'update', array('gp_id' => $model->id));
    ...
    public function saveModel(?\Gp $model)
    {
        $model->nat_id = $this->getAssignedProperty('Code');
