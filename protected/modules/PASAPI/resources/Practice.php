...
class Practice extends BaseResource
{
    protected static $resource_type = 'Practice';
    protected static $model_class = 'Practice';
    ...
    public function save()
    {
        ...
        try {
            if ($this->saveModel($model)) {
                ...
                $this->audit($this->isNewResource ? 'create' : 'update', array('practice_id' => $model->id));
    ...
    public function saveModel(?\Practice $model)
    {
