 ...
 * @group pas-api
 */
class PASAPI_Patient_Test_V2 extends PASAPI_BaseTest
{
    protected string $pas_api_test_base_url = 'http://localhost/PASAPI/V2/';
...
EOF;
    ...
    public function testPartialUpdate($initial, $partial, $expected_values)
    {
        ...
        $this->put('4534563', $partial, array(
