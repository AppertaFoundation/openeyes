 ...
 *
 * The followings are the available columns in table 'ophdrpgdpsd_assigneduser':
 * @property integer $id
...
class OphDrPGDPSD_AssignedUser extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophdrpgdpsd_assigneduser';
    }
    ...
    public function rules()
    {
        ...
        return array(
            array('pgdpsd_id, user_id', 'required'),
            ...
            array('id, pgdpsd_id, user_id, last_modified_user_id, last_modified_date, created_user_id, created_date', 'safe', 'on'=>'search'),
        );
    }
