...
<section class="sub-element">
  ...
  <div class="element-data">
    <div class="row data-row">
      <div class="large-2 column">
        <div class="data-label"><?php echo $element->getAttributeLabel('extracted_by_id') ?>:</div>
      </div>
      <div class="large-10 column">
        <div class="data-value">
            <?php
            if($element->extracted_by) {
              echo CHtml::encode($element->extracted_by->getFullName());
            }
            if($element->extracted_by_text) {
                echo ' (From Import: ' . CHtml::encode($element->extracted_by_text) . ')';
            }
            ?>
        </div>
      </div>
