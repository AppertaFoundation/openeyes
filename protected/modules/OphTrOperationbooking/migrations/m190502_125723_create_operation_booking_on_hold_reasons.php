...
class m190502_125723_create_operation_booking_on_hold_reasons extends OEMigration
{
	public function up()
	{
        ...
        $this->addColumn('ophtroperationbooking_operation_booking', 'on_hold_reason', 'varchar(100) NULL');
        $this->addColumn('ophtroperationbooking_operation_booking_version', 'on_hold_reason', 'varchar(100) NULL');
        $this->addColumn('ophtroperationbooking_operation_booking', 'on_hold_comment', 'varchar(200) NULL');
        $this->addColumn('ophtroperationbooking_operation_booking_version', 'on_hold_comment', 'varchar(200) NULL');
	}

	public function down()
	{
	    $this->dropColumn('ophtroperationbooking_operation_booking', 'on_hold_comment');
	    $this->dropColumn('ophtroperationbooking_operation_booking_version', 'on_hold_comment');
	    $this->dropColumn('ophtroperationbooking_operation_booking', 'on_hold_reason');
	    $this->dropColumn('ophtroperationbooking_operation_booking_version', 'on_hold_reason');
