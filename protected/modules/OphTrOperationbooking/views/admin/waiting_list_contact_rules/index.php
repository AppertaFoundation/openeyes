...
<div class="row flex-layout divider">
    <h2 class="box-title flex-left">Waiting list contact rules</h2>
    <?=\CHtml::submitButton('Add waiting list contact rule', ['class' => 'button large flex-right', 'id' => 'et_add_letter_contact_rule']); ?>
</div>
    ...
    <form id="rulestest" class="panel">
        <table class="standard">
            <tr>
                ...
                <td><?=\CHtml::dropDownList('lcr_service_id', '', CHtml::listData(Service::model()->findAll(array('order' => 'name asc')), 'id', 'name'), ['class' => 'cols-11', 'empty' => '- Service -'])?></td>
