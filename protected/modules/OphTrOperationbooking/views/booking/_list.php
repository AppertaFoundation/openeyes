...
<?php if ($bookable) { ?>
    ...
    <div class="data-group">
        <button type="submit" class="large green hint" id="confirm_slot" data-booking-is-preferred="<?= $session->operationBookingPreferred($operation) ? "true" : "false" ?>">Confirm slot</button>
