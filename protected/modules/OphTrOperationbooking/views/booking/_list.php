...
<?php if ($bookable) { ?>
    ...
    <div class="data-group">
        <button type="submit" class="large green hint" id="confirm_slot" data-place-for-complex-procedure="<?= $session->isTherePlaceForComplexProcedure($operation) ? "true" : "false" ?>">Confirm slot</button>
