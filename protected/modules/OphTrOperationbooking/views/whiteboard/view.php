...
<head>
<style type='text/css'>
* { font: 16pt arial, sans-serif; color: black; }
b { color: black; }
td p { color: white; }
td { color: white; background-color: #bdd7ee; border-radius: 10px; padding:10px; }
td.highlight { background-color: #f8cbad !important; }
</style>
</head>
