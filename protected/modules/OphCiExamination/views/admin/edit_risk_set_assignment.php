        ...
        <tr>
            <td colspan="3">
                <div class="patient-activity">
                    <input placeholder="Type to search" class="cols-full search autocompletesearch"
                           id="medication_set_id" type="text" value="" name="medication_set_id" autocomplete="off">
