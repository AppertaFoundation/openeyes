...
<div class="element-fields full-width ">
    ...
    ?> style="display: none;"<?php } ?>>
      ...
      <div class="cols-10">
				<?php $html_options = array('empty' => '- Please select -', 'options' => array());
	...
	<div class="flex-layout" id="div_<?php echo CHtml::modelName($element)?>_role"<?php if (!($element->status && $element->status->followup)) {
    ?> style="display: none;"<?php }?>>
    <div class="cols-2">
      <?php echo $element->getAttributeLabel('role')?>:
    </div>
    <div class="cols-10">
        <?php $html_options = array('empty' => '- Please select -', 'nowrapper' => true, 'options' => array());
