...
<div class="eyedraw-fields">
  ...
  <div style="display:none;" class="basic-mode">
    ...
    <div class="gonio-cross">
        <div class="gonio-sup">
            <?=\CHtml::dropDownList(
                $side . '_gonio_sup_basic',
                ($element->{$side . '_gonio_sup_id'} <= 4) ? 1 : 0,
                $basic_options,
        ...
        <div class="gonio-tem">
            <?=\CHtml::dropDownList(
                $side . '_gonio_tem_basic',
                ($element->{$side . '_gonio_tem_id'} <= 4) ? 1 : 0,
                $basic_options,
        ...
        <div class="gonio-nas">
            <?=\CHtml::dropDownList(
                $side . '_gonio_nas_basic',
                ($element->{$side . '_gonio_nas_id'} <= 4) ? 1 : 0,
                $basic_options,
        ...
        <div class="gonio-inf">
            <?=\CHtml::dropDownList(
                $side . '_gonio_inf_basic',
                ($element->{$side . '_gonio_inf_id'} <= 4) ? 1 : 0,
                $basic_options,
