      ...
      <div class="js-element-eye <?= $eye_side ?>-eye column">
          <?php if ($element->hasEye($eye_side)) { ?>
            <table class="cols-full">
              ...
              <tr>
                <td>
                    <?php echo $element->getAttributeLabel($eye_side . '_endothelial_cell_density_value') ?>:
                </td>
                <td>
                    <?php echo $element->{$eye_side . '_endothelial_cell_density_value'}; ?>
                </td>
              </tr>
              <tr>
                <td>
                    <?php echo $element->getAttributeLabel($eye_side . '_coefficient_variation_value') ?>:
                </td>
                <td>
                    <?php echo $element->{$eye_side . '_coefficient_variation_value'}; ?>
                </td>
              </tr>
              </tbody>
            </table>
