...
<script type="text/javascript">
    ...
    function disableClickAssessmentList() {
        ...
        $('section.OEModule_OphCiExamination_models_OCT .select-options li').css({"pointer-events": "", "opacity": ""});
    ...
    function addAssessmentsToList($element, data) {
        ...
        rows.find('.js-assessment-container').each(function (index) {
            if (index < rows.length - 1) {
                $(this).css({"border-bottom" : "2px dotted #9e9ec7", "padding" : "0 0 0.5em 0", "margin" : "0 0 0.5em 0"});
            }
        });
    }
