...
<?php foreach (array('left' => 'right', 'right' => 'left') as $page_side => $eye_side): ?>
    ...
    <div class="js-element-eye <?=$eye_side?>-eye <?=$page_side?> side <?=(!$element->hasEye($eye_side))? "inactive":""?>" data-side="<?=$eye_side?>">
...
<div class="element-fields element-eyes row" id="<?= $model_name ?>_element">
        ...
        <div class="js-element-eye right-eye column side left<?=!$element->hasRight() ? ' inactive': '';?>" data-side="right">
        ...
        <div class="js-element-eye left-eye column side right<?=!$element->hasLeft() ? ' inactive': '';?>" data-side="left">
            <div class="active-form">
                <a href="#" class="icon-remove-side remove-side">Remove side</a>
                <div class="van_herick field-row">
