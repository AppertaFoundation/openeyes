...
class StereoAcuity extends \BaseEventElementWidget
{
    ...
    {
        $this->render($this->getViewForEntry(), $this->getViewDataForEntry(new StereoAcuity_Entry()));
    }
    ...
    {
        return StereoAcuity_Entry::model()->getAttributeLabel($attr);
    }
    ...
    {
        return $this->getViewNameForPrefix('StereoAcuity_Entry');
    }

    protected function getViewDataForEntry(StereoAcuity_Entry $entry, $index = '{{row_count}}')
    {
        return [
            'row_count' => $index,
