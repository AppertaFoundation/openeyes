...
class OphCiExamination_Episode_Keratometry_Chart extends \EpisodeSummaryWidget
{
    public $collapsible = true;
    public $openOnPageLoad = true;

    protected $chart_id = 'keratoconus-history-chart';
    protected $kera_unit_input = 'va_history_unit_id';
