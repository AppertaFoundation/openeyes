...
/**
 * Class OphCiExamination_VisualAcuityUnitTest
 *
 * @package OEModule\OphCiExamination\tests\unit\models
 * @covers \OEModule\OphCiExamination\models\OphCiExamination_VisualAcuityUnit
 * @group sample-data
 * @group strabismus
 * @group visual-acuity
 */
class OphCiExamination_VisualAcuityUnitTest extends \OEDbTestCase
{
    use \WithFaker;
    ...
    {
        $instance = new OphCiExamination_VisualAcuityUnit();
