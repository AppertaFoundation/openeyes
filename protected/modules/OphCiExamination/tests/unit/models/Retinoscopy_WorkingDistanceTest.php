...
/**
 * Class RetinoscopyWorkingDistanceTest
 *
 * @package OEModule\OphCiExamination\tests\unit\models
 * @covers \OEModule\OphCiExamination\models\Retinoscopy_WorkingDistance
 * @group sample-data
 * @group strabismus
 * @group retinoscopy
 */
class Retinoscopy_WorkingDistanceTest extends \ModelTestCase
{
    use \WithFaker;
