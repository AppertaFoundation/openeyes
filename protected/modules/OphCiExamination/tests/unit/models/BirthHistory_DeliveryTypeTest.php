...
/**
 * Class BirthHistory_DeliveryTypeTest
 *
 * @package OEModule\OphCiExamination\tests\unit\models
 * @covers \OEModule\OphCiExamination\models\BirthHistory_DeliveryType
 * @group sample-data
 * @group strabismus
 * @group birth-history
 */
class BirthHistory_DeliveryTypeTest extends \ModelTestCase
{
    use \WithFaker;
    use HasLookupBehavioursToTest;

    protected $element_cls = BirthHistory_DeliveryType::class;
}