...
/**
 * Class SensoryFunction_EntryTypeTest
 *
 * @package OEModule\OphCiExamination\tests\unit\models
 * @covers \OEModule\OphCiExamination\models\SensoryFunction_EntryType
 * @group sample-data
 * @group strabismus
 * @group sensory-function
 */
class SensoryFunction_EntryTypeTest extends \ModelTestCase
{
    use \WithFaker;
