    ...
    <div class="cols-5">
            ...
            'checkboxes' => [
                ...
                'value' => function ($data, $row) {
                    return CHtml::checkBox(
                        "OEModule_OphCiExamination_models_OphCiExaminationPupillaryAbnormalitySet[]",
                        false,
                        ['value' => $data->id]
                    );
                },
        ...
        <?=\CHtml::submitButton(
            ...
            [
                'class' => 'button large',
                'name' => 'add',
                'data-uri' => '/OphCiExamination/admin/PupillaryAbnormalityAssignment/create/',
                'id' => 'et_add'
            ]
        ); ?>
        ...
        <?=\CHtml::submitButton(
            ...
            [
                'class' => 'button large',
                'name' => 'delete',
                'data-uri' => '/OphCiExamination/admin/PupillaryAbnormalityAssignment/delete',
                'id' => 'et_delete'
            ]
        ); ?>
