...
class OphCiExaminationRisk extends \BaseActiveRecordVersioned
{
    ...
    {
        if($this->age_min === "0" || $this->age_min === ""){
            $this->age_min = null;
        }

        if($this->age_max === "0" || $this->age_max === ""){
            $this->age_max = null;
        }
    ...
    public function rules()
    {
        ...
        return array(
            array('name, tags, subspecialty_id, firm_id, episode-status_id, gender, age_min, age_max', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('age_min, age_max', 'numerical'),
