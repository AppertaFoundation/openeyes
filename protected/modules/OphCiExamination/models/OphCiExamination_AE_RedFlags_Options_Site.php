 ...
 */
class OphCiExamination_AE_RedFlags_Options_Site extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophciexamination_ae_red_flags_option_site';
    }

    public function rules()
    {
        return [
            ['id, red_flag_id, site_id', 'safe', 'on' => 'search'],
        ];
    }
