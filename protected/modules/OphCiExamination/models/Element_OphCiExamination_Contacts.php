...
/**
 * This is the model class for table "et_ophciexamination_contacts".
 *
 * The followings are the available columns in table 'et_ophciexamination_contacts':
 * @property integer $id
...
class Element_OphCiExamination_Contacts extends \BaseEventTypeElement
{
    ...
    {
        return 'et_ophciexamination_contacts';
    }
