...
use OEModule\OphCiExamination\models\OphCiExaminationAllergyEntry;

/**
 * This is the model class for table "ophciexamination_allergy_set_entry".
 *
 * The followings are the available columns in table 'ophciexamination_allergy_set_entry':
 * @property integer $id
 * @property integer $ophciexamination_allergy_id
 ...
 * @property OphciexaminationAllergySetAssignment[] $ophciexaminationAllergySetAssignments
 * @property OphciexaminationAllergy $ophciexaminationAllergy
...
class OphCiExaminationAllergySetEntry extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophciexamination_allergy_set_entry';
    }
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, ophciexamination_allergy_id, gender, age_min, age_max, last_modified_user_id, last_modified_date, created_user_id, created_date', 'safe', 'on'=>'search'),
        );
    }
