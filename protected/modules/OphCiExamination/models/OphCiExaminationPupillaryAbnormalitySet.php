...
/**
 * This is the model class for table "ophciexamination_pupillary_abnormality_set.
 *
 * The followings are the available columns in table 'ophciexamination_pupillary_abnormality_set':
 * @property integer $id
...
class OphCiExaminationPupillaryAbnormalitySet extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophciexamination_pupillary_abnormality_set';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'entries' => array(self::HAS_MANY, OphCiExaminationPupillaryAbnormalitySetEntry::class, 'set_id'),
        );
    }
     ...
     * @return OphCiExaminationPupillaryAbnormalitySet the static model class
     */
