...
class OphCiExaminationRiskSetEntry extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophciexamination_risk_set_entry';
    }
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('ophciexamination_risk_id, gender, age_min, age_max, last_modified_date, created_date', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, ophciexamination_risk_id, gender, age_min, age_max, last_modified_user_id, last_modified_date, created_user_id, created_date', 'safe', 'on'=>'search'),
        );
    }
