...
/**
 * This is the model class for table "ophciexamination_colourvision_method".
 *
 * @property int $id
...
class OphCiExamination_ColourVision_Method extends \BaseActiveRecordVersioned
{
    ...
    {
        return array(
            'values' => array(self::HAS_MANY, 'OEModule\OphCiExamination\models\OphCiExamination_ColourVision_Value', 'method_id'),
        );
    }
