...
/**
 * Class CoverAndPrismCover_VerticalPrism
 *
 * @package OEModule\OphCiExamination\models
 * @property string $name
 */
class CoverAndPrismCover_VerticalPrism extends \BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophciexamination_coverandprismcover_verticalprism';
    }
