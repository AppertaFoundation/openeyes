 ...
 */
class OphCiExamination_AE_RedFlags_Options_Subspecialty extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophciexamination_ae_red_flags_option_subspecialty';
    }

    public function rules()
    {
        return [
            ['id, red_flag_id, subspecialty_id', 'safe', 'on' => 'search'],
        ];
    }
