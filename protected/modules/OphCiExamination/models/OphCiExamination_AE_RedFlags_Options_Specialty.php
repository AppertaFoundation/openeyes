 ...
 */
class OphCiExamination_AE_RedFlags_Options_Specialty extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophciexamination_ae_red_flags_option_specialty';
    }

    public function rules()
    {
        return [
            ['id, red_flag_id, specialty_id', 'safe', 'on' => 'search'],
        ];
    }
