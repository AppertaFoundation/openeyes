...
/**
 * Class Synoptophore_Deviation
 *
 * @package OEModule\OphCiExamination\models
 * @property string $name
 */
class Synoptophore_Deviation extends \BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophciexamination_synoptophore_deviation';
    }
    ...
    public function rules()
    {
        return [
            ...
            ['abbreviation', 'length', 'max' => 7, 'min' => 2],
            ['active', 'boolean'],
