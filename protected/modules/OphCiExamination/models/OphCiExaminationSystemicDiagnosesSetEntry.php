...
/**
 * This is the model class for table "ophciexamination_systemic_diagnoses_set_entry".
 *
 * The followings are the available columns in table 'ophciexamination_systemic_diagnoses_set_entry':
 * @property integer $id
 ...
 * @property OphciexaminationSystemicDiagnosesSetAssignment[] $ophciexaminationSystemicDiagnosesSetAssignments
...
class OphCiExaminationSystemicDiagnosesSetEntry extends \BaseActiveRecordVersioned
{
    ...
    {
        return 'ophciexamination_systemic_diagnoses_set_entry';
    }
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, disorder_id, gender, age_min, age_max, last_modified_user_id, last_modified_date, created_user_id, created_date', 'safe', 'on'=>'search'),
        );
    }
