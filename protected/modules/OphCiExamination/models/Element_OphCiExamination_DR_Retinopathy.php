...
/**
 * This is the model class for table "et_ophciexamination_dr_retinopathy".
 *
 * The followings are the available columns in table 'et_ophciexamination_dr_retinopathy':
 * @property integer $id
 ...
 * @property RetinopathyFeature[] $features
 * @property RetinopathyFeature[] $left_retinopathy_features
 * @property RetinopathyFeature[] $right_retinopathy_features
 */
...
class Element_OphCiExamination_DR_Retinopathy extends SplitEventTypeElement
{
    ...
    {
        return 'et_ophciexamination_dr_retinopathy';
    }
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('left_retinopathy_features', 'requiredIfSide', 'side' => 'left'),
            array('right_retinopathy_features', 'requiredIfSide', 'side' => 'right'),
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'features' => array(
                self::MANY_MANY,
                OphCiExamination_DRGrading_Feature::class,
                'ophciexamination_dr_retinopathy_entry(element_id, feature_id)',
            ),
            'left_retinopathy_features' => array(
                self::HAS_MANY,
                RetinopathyFeature::class,
                'element_id',
                'on' => ('left_retinopathy_features.eye_id = '.\Eye::LEFT),
            ),
            'right_retinopathy_features' => array(
                self::HAS_MANY,
                RetinopathyFeature::class,
                'element_id',
                'on' => ('right_retinopathy_features.eye_id = '.\Eye::RIGHT),
            ),
            'retinopathy_features' => array(
                self::HAS_MANY,
                RetinopathyFeature::class,
                'element_id',
            ),
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'left_retinopathy_features' => 'Retinopathy Features',
            'right_retinopathy_features' => 'Retinopathy Features',
     ...
     * @return Element_OphCiExamination_DR_Retinopathy the static model class
     */
    ...
    public function updateFeatures($side, $features)
    {
        ...
        foreach ($this->retinopathy_features as $r) {
            if ($r->eye_id == $side) {
        ...
        foreach ($features as $feature) {
            if (!array_key_exists($feature['feature_id'], $curr_by_id)) {
                // Create new instance
                $obj = new RetinopathyFeature();
            } else {
                // Bring existing instance forward without change.
