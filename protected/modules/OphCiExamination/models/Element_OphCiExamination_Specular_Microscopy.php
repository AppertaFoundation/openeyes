...
class Element_OphCiExamination_Specular_Microscopy extends \SplitEventTypeElement
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('right_coefficient_variation_value, right_coefficient_variation_value', 'numerical',
                'integerOnly'=>false),
//                array('right_coefficient_variation_value, right_coefficient_variation_value', 'in','range'=>range(0,100)),
