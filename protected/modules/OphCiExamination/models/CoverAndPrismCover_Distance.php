...
/**
 * Class CoverAndPrismCover_Distance
 *
 * @package OEModule\OphCiExamination\models
 * @property string $name
 */
class CoverAndPrismCover_Distance extends \BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophciexamination_coverandprismcover_distance';
    }
