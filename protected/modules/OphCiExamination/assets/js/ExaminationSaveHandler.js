    ...
    function verifyElements(e, $form) {
        ...
        if (empty_mandatory_element || dirty_elements.length === 0) {
            ...
            let dialog = new OpenEyes.UI.Dialog.Confirm({
                ...
                rightPanelContent: "The listed elements have received no input or are in-complete, would you like to discard them and continue to save?",
                okButton: 'Discard & save',
                cancelButton: 'Cancel, go back',
