...
class m170421_142858_create_family_history extends OEMigration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey(
            'et_ophciexamination_familyhistory_ev_fk',
            'et_ophciexamination_familyhistory',
            'event_id',
            'event',
            'id'
        );
        ...
        $this->addForeignKey(
            'ophciexamination_familyhistory_entry_el_fk',
            'ophciexamination_familyhistory_entry',
            'element_id',
            'et_ophciexamination_familyhistory',
            'id'
        );
        ...
        $this->addForeignKey(
            'ophciexamination_familyhistory_entry_rel_fk',
            'ophciexamination_familyhistory_entry',
            'relative_id',
            'ophciexamination_familyhistory_relative',
            'id'
        ...
        $this->addForeignKey(
            'ophciexamination_familyhistory_entry_side_fk',
            'ophciexamination_familyhistory_entry',
            'side_id',
            'ophciexamination_familyhistory_side',
            'id'
        ...
        $this->addForeignKey(
            'ophciexamination_familyhistory_entry_con_fk',
            'ophciexamination_familyhistory_entry',
            'condition_id',
            'ophciexamination_familyhistory_condition',
            'id'
