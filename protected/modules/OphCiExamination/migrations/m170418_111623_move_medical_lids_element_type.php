...
class m170418_111623_move_medical_lids_element_type extends CDbMigration
{
    public function up()
    {
        $this->execute('UPDATE element_type JOIN element_type AS j ON j.class_name = :parent
    ...
    {
        $this->execute("UPDATE element_type SET parent_element_type_id = NULL, display_order = 55
