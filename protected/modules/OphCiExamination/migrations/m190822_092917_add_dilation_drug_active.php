...
class m190822_092917_add_dilation_drug_active extends CDbMigration
{
    public function up()
    {
        $this->addColumn('ophciexamination_dilation_drugs', 'is_active', "TINYINT(1) DEFAULT 1");
        $this->addColumn('ophciexamination_dilation_drugs_version', 'is_active', "TINYINT(1) DEFAULT 1");
    }
