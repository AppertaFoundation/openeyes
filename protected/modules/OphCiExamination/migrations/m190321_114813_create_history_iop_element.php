...
class m190321_114813_create_history_iop_element extends OEMigration
{
    public function up()
    {
        $this->createOETable('et_ophciexamination_history_iop', array(
            'id' => 'pk',
    ...
    {
        $this->delete('element_type', 'class_name = :class_name', array(':class_name' => 'OEModule\OphCiExamination\models\HistoryIOP'));
