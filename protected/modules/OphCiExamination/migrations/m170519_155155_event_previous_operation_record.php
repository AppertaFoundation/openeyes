...
class m170519_155155_event_previous_operation_record extends OEMigration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey(
            'et_ophciexamination_pastsurgery_ev_fk',
            'et_ophciexamination_pastsurgery',
            'event_id',
            'event',
            'id'
        );
        ...
        $this->addForeignKey(
            'ophciexamination_pastsurgery_op_el_fk',
            'ophciexamination_pastsurgery_op',
            'element_id',
            'et_ophciexamination_pastsurgery',
            'id'
        );
        ...
        $this->addForeignKey(
            'ophciexamination_pastsurgery_op_side_fk',
            'ophciexamination_pastsurgery_op',
            'side_id',
            'eye',
            'id'
