...
class m141119_164500_move_findings_to_core extends OEMigration
{
    ...
    public function down()
    {
        ...
        $this->addForeignKey('ophciexamination_further_findings_subspec_f_id_fk', 'ophciexamination_further_findings_subspec_assignment',
            'further_finding_id', 'ophciexamination_further_findings', 'id');
        $this->addForeignKey('ophciexamination_further_findings_assign_f_id_fk', 'ophciexamination_further_findings_assignment',
            'further_finding_id', 'ophciexamination_further_findings', 'id');
    }
}
