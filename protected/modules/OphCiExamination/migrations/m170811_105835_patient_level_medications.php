...
class m170811_105835_patient_level_medications extends OEMigration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey('et_ophciexamination_hmeds_ev_fk',
            'et_ophciexamination_history_medications', 'event_id', 'event', 'id');

        $this->duplicateTable('medication_stop_reason',
        ...
        $this->addForeignKey('ophciexamination_history_meds_entry_el_fk',
            'ophciexamination_history_medications_entry', 'element_id', 'et_ophciexamination_history_medications', 'id');
        $this->addForeignKey('ophciexamination_history_meds_entry_did_fk',
            'ophciexamination_history_medications_entry', 'drug_id', 'drug', 'id');
        $this->addForeignKey('ophciexamination_history_meds_entry_mdid_fk',
            'ophciexamination_history_medications_entry', 'medication_drug_id', 'medication_drug', 'id');
        $this->addForeignKey('ophciexamination_history_meds_entry_route_fk',
            'ophciexamination_history_medications_entry', 'route_id', 'drug_route', 'id');
        $this->addForeignKey('ophciexamination_history_meds_entry_roption_fk',
            'ophciexamination_history_medications_entry', 'option_id', 'drug_route_option', 'id');
        $this->addForeignKey('ophciexamination_history_meds_entry_freq_fk',
            'ophciexamination_history_medications_entry', 'frequency_id', 'drug_frequency', 'id');
        $this->addForeignKey('ophciexamination_history_meds_entry_stopid_fk',
            'ophciexamination_history_medications_entry', 'stop_reason_id', 'ophciexamination_medication_stop_reason', 'id');
