 ...
 */
class OphInGeneticresultsModule extends BaseEventTypeModule
{
    ...
    public function init()
    {
        ...
        $this->setImport(array(
            'OphInGeneticresults.models.*',
            'OphInGeneticresults.components.*',
            'Genetics.models.*',
        ));

        $this->moduleShortSuffix = 'geneticresults';
    }
