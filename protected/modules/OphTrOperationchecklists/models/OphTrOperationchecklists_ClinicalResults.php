...
/**
 * This is the model class for table "ophtroperationchecklists_clinical_results".
 *
 * The followings are the available columns in table 'ophtroperationchecklists_clinical_results':
 * @property integer $id
 ...
 * @property Element_OphTrOperationchecklists_ClinicalAssessment $element
 * @property OphTrOperationchecklists_ElementSet $set
 * @property OphTrOperationchecklists_Questions $question
 * @property User $createdUser
 * @property User $lastModifiedUser
 */
class OphTrOperationchecklists_ClinicalResults extends BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophtroperationchecklists_clinical_results';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'element' => array(self::BELONGS_TO, 'Element_OphTrOperationchecklists_ClinicalAssessment', 'element_id'),
     ...
     * @return OphTrOperationchecklists_ClinicalResults the static model class
     */
