...
/**
 * This is the model class for table "ophtroperationchecklists_nursing_results".
 *
 * The followings are the available columns in table 'ophtroperationchecklists_nursing_results':
 * @property integer $id
 ...
 * @property Element_OphTrOperationchecklists_NursingAssessment $element
 * @property OphTrOperationchecklists_ElementSet $set
 * @property OphTrOperationchecklists_Questions $question
 * @property User $createdUser
 * @property User $lastModifiedUser
 */
class OphTrOperationchecklists_NursingResults extends BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophtroperationchecklists_nursing_results';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'element' => array(self::BELONGS_TO, 'Element_OphTrOperationchecklists_NursingAssessment', 'element_id'),
     ...
     * @return OphTrOperationchecklists_NursingResults the static model class
     */
