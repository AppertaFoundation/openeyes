...
/**
 * This is the model class for table "ophtroperationchecklists_patient_support_results".
 *
 * The followings are the available columns in table 'ophtroperationchecklists_patient_support_results':
 * @property integer $id
 ...
 * @property Element_OphTrOperationchecklists_PatientSupport $element
 * @property OphTrOperationchecklists_ElementSet $set
 * @property OphTrOperationchecklists_Questions $question
 */
class OphTrOperationchecklists_PatientSupportResults extends BaseActiveRecordVersioned
{
    /**
    ...
    {
        return 'ophtroperationchecklists_patient_support_results';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'element' => array(self::BELONGS_TO, 'Element_OphTrOperationchecklists_PatientSupport', 'element_id'),
     ...
     * @return OphTrOperationchecklists_PatientSupportResults the static model class
     */
