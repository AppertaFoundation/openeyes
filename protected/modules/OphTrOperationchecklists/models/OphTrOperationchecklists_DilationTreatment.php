...
/**
 * This is the model class for table "ophtroperationchecklists_dilation_treatment".
 *
 * The followings are the available columns in table 'ophtroperationchecklists_dilation_treatment':
 * @property string $id
 ...
 * @property OphTrOperationchecklists_Dilation $element
 * @property User $lastModifiedUser
 */
class OphTrOperationchecklists_DilationTreatment extends CActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * Please note that you should have this exact method in all your CActiveRecord descendants!
     * @param string $className active record class name.
     * @return OphTrOperationchecklists_DilationTreatment the static model class
     */
    ...
    {
        return 'ophtroperationchecklists_dilation_treatment';
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'dilation' => array(self::BELONGS_TO, 'OphTrOperationchecklists_Dilation', 'dilation_id'),
