...
/**
 * This is the model class for table "ophtroperationchecklists_proclist_proc_assignment".
 *
 * The followings are the available columns in table 'ophtroperationchecklists_proclist_proc_assignment':
 * @property integer $id
...
class OphTrOperationchecklists_ProcedurelistProcedureAssignment extends \BaseEventTypeElement
{
    ...
    {
        return 'ophtroperationchecklists_proclist_proc_assignment';
    }
     ...
     * @return OphTrOperationchecklists_ProcedurelistProcedureAssignment the static model class
     */
