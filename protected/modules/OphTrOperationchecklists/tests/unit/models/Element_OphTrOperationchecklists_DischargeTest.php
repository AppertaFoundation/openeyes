...
class Element_OphTrOperationchecklists_DischargeTest extends ActiveRecordTestCase
{
    /**
     * @var Element_OphTrOperationchecklists_Discharge
     */
    protected Element_OphTrOperationchecklists_Discharge $model;
    ...
    {
        parent::setUp();
        $this->model = new Element_OphTrOperationchecklists_Discharge();
    }

    /**
     * @covers Element_OphTrOperationchecklists_Discharge
     */
    public function testModel()
    {
        $this->assertEquals('Element_OphTrOperationchecklists_Discharge', get_class($this->model), 'Class name should match model');
    }
    ...
    {
        $this->assertEquals('et_ophtroperationchecklists_discharge', $this->model->tableName());
    }

    /**
     * @covers Element_OphTrOperationchecklists_Discharge
     */
    public function testSaveDischargeData()
    {
        $event = $this->event('event1');

        $element = new Element_OphTrOperationchecklists_Discharge();
        ...
        if (isset($question)) {
            $result = new OphTrOperationchecklists_DischargeResults();
