...
class Element_OphTrOperationchecklists_ClinicalAssessmentTest extends ActiveRecordTestCase
{
    ...
    public function testSaveClinicalData()
    {
        ...
        if (isset($question)) {
            ...
            $checklist_results = OphTrOperationchecklists_ClinicalResults::model()->findAll('element_id = :element_id AND question_id = :question_id', array(':element_id' => $element->id, ':question_id' => $question->id));
