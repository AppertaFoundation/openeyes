...
class Element_OphTrOperationchecklists_PatientSupportTest extends ActiveRecordTestCase
{
    ...
    public function testSavePatientSupportData()
    {
        ...
        if (isset($question)) {
            ...
            $checklist_results = OphTrOperationchecklists_PatientSupportResults::model()->findAll('element_id = :element_id AND question_id = :question_id', array(':element_id' => $element->id, ':question_id' => $question->id));
