...
/**
 * @var Element_OphTrOperationchecklists_Documentation $element
 */
...
$this->renderPartial('checklist_edit', array(
    ...
    'questions' => $questions,
    'name_stub' => $name_stub,
    'model_relation' => 'Element_OphTrOperationchecklists_Documentation_checklistResults_',
    'result_model' => OphTrOperationchecklists_DocumentationResults::model(),
