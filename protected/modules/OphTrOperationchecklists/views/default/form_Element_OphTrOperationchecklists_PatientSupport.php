...
/**
 * @var Element_OphTrOperationchecklists_PatientSupport $element
 */
...
$results = Yii::app()->db->createCommand()
    ...
    ->from('ophtroperationchecklists_patient_support_results')
...
$this->renderPartial('checklist_edit', array(
    ...
    'questions' => $questions,
    'name_stub' => $name_stub,
    'model_relation' => 'Element_OphTrOperationchecklists_PatientSupport_checklistResults_',
    'result_model' => OphTrOperationchecklists_PatientSupportResults::model(),
