...
class Element_OphTrConsent_Withdrawal extends BaseEventTypeElement implements RequiresSignature
{
    ...
    public function rules()
    {
        ...
        return array(
            array('event_id, withdrawn, withdrawal_reason', 'safe'),
            array('id, event_id, withdrawn, withdrawal_reason', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('signatuer_id', $this->signatuer_id, true);
        $criteria->compare('withdrawn', $this->withdrawn, true);
