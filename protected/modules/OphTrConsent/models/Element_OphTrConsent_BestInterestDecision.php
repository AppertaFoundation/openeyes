 ...
 * @property integer $deputy_granted
 * @property string $circumstances
 * @property string $imca_view
 * @property string $options_less_restrictive
 * @property string $views_of_colleagues
 * @property string $decision
 * @property integer $protected_file_id
 * @property integer $no_decision_made
...
class Element_OphTrConsent_BestInterestDecision extends \BaseEventTypeElement
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('deputy_granted, circumstances, imca_view, options_less_restrictive, views_of_colleagues, decision, protected_file_id, no_decision_made', 'safe'),
