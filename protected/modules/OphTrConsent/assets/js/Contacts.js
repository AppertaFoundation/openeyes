 ...
 */
 ...
 OpenEyes.OphTrConsent = OpenEyes.OphTrConsent || {};
 
 (function (exports) {
     function AttorneyDeputyContactsController(options) {
         this.options = $.extend(true, {}, AttorneyDeputyContactsController._defaultOptions, options);
     ...
     AttorneyDeputyContactsController._defaultOptions = {
         modelName: 'OEModule_OphTrConsent_models_Allergies',
         contactFilterId: 'contact-type-filter'
     };
 
     AttorneyDeputyContactsController.prototype.initialiseTriggers = function () {
         let controller = this;
      ...
      * @returns {*}
      */
     AttorneyDeputyContactsController.prototype.createRows = function (contact = {}) {
         let controller = this;
         let newRows = [];
         let data = {};
         let row;
     ...
     AttorneyDeputyContactsController.prototype.isContactInTable = function (selected_contacts) {
      ...
      */
     AttorneyDeputyContactsController.prototype.addEntry = function (selectedItems) {
         let controller = this;
         let selectedFilter;
     ...
     AttorneyDeputyContactsController.prototype.getContactLabelLimit = function (filterName) {
         let controller = this;
         let contactLabel = $(controller.contactFilterSelector).find('li[data-label="' + filterName + '"]');
         return contactLabel.data('patient_limit');
     };
 
     AttorneyDeputyContactsController.prototype.isContactTypeAboveLimit = function (contactLabel, contactLimit) {
         let controller = this;
     ...
     AttorneyDeputyContactsController.prototype.showSameContactDialog = function (contact) {
     ...
     AttorneyDeputyContactsController.prototype.showPatientContactLimitDialog = function (
         selectedFilterName,
         patientContactLimit,
     ...
     AttorneyDeputyContactsController.prototype.openAddNewContactDialog = function (filter) {
         let controller = this;
         let contactDialog = new OpenEyes.UI.Dialog($.extend({}, this.addContactDialogOptions, {
             url: baseUrl + '/OphTrConsent/contact/ContactPage',
             width: 500,
             data: {
                 returnUrl: "",
     ...
     AttorneyDeputyContactsController.prototype.initialiseDialogTriggers = function (contactDialog) {
         let controller = this;
     ...
     AttorneyDeputyContactsController.prototype.handleContactTypeLabelError = function (contactTypeLimitReached, selectedLabel) {
         let contactLabelError;
     ...
     AttorneyDeputyContactsController.prototype.getDataFromAddNewContactDialog = function () {
         let data = {};
     ...
     AttorneyDeputyContactsController.prototype.saveNewContact = function (data) {
         let controller = this;
         $.ajax({
             'type': 'POST',
             'data': "data=" + JSON.stringify(data) + "&YII_CSRF_TOKEN=" + YII_CSRF_TOKEN,
             'url': baseUrl + '/OphTrConsent/contact/saveNewContact',
     ...
     AttorneyDeputyContactsController.prototype.deleteByContactLabel = function (contactLabelName) {
         let controller = this;
         controller.$table.find('.js-contact-label').each(function () {
     ...
     exports.AttorneyDeputyContactsController = AttorneyDeputyContactsController;
 })(OpenEyes.OphTrConsent);
