...
<div class="element-fields full-width">
    ...
    <?php else : ?>
        <div class="row flex">
            ...
            <div>
                <button type="submit" id="withdraw-submit-button" class="red hint">Withdraw consent</button>
                &emsp;
                <button class="blue hint js-remove-element">Cancel consent withdrawal</button>
            </div>
        </div>
    <?php endif; ?>
</div>