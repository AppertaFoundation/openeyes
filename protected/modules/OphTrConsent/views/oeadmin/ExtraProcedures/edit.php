    ...
    <form method="POST">
        ...
        <table class="standard cols-full">
            ...
            <tbody>
                ...
                $mapping_fields = ['institution_id', 'proc_id '];
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $instituition= Institution::model()->findAll(
                            array('order' => 'name')
                        );
                        $inslist = CHtml::listData(
                            $instituition,
                            'id',
                            'name'
                        );
                        ...
                        echo CHtml::dropDownList(
                            ...
                            $instituition,
                            $inslist,
                            array('empty' => '(Select an Instiution)')
                        );
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $mainProc= Procedure::model()->findAll(
                            array('order' => 'short_format')
                        );
                        $mainProclist = CHtml::listData(
                            $mainProc,
                            'id',
                            'short_format'
                        );
                        ...
                        echo CHtml::dropDownList(
                            ...
                            $mainProc,
                            $mainProclist,
                            array('empty' => '(Select a Main Procedure)')
                        );
