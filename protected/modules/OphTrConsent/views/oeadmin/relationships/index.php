...
<form id="relationships" method="POST">
    ...
    <div class="cols-7">
        <table class="standard cols-full" id="finding-table">
            ...
            <?php foreach ($relationships as $key => $relationship) :
                ...
                $this->renderPartial('/oeadmin/relationships/_row', ['data' => $data]);
            endforeach; ?>
            </tbody>
            <tfoot>
            <tr>
                <td colspan="6">
                    <?=\CHtml::htmlButton(
                        ...
                        [
                            ...
                            'name' => 'admin-add',
                            'type' => 'button',
                            'data-model' => 'OphTrConsent_relationship',
                            'id' => 'et_admin-add'
                        ]
                    ); ?>
                    <?=\CHtml::submitButton(
...
<script type="text/template" id="finding-row-template" style="display:none">
    <?php
    $data = [
        'relationship' => new OphTrConsent_PatientRelationship(),
        'key' => '{{key}}'
    ];
    $this->renderPartial('/oeadmin/relationships/_row', ['data' => $data]);
    ?>
