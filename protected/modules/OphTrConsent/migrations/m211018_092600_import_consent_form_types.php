...
class m211018_092600_import_consent_form_types extends OEMigration
{
    ...
    private const ET_ARCHIVE_TABLE = 'et_ophtrconsent_type_archive';
    ...
    public function safeUp()
    {
        ...
        if (!$this->dbConnection->schema->getTable(self::ET_ARCHIVE_TABLE, true)) {
            $this->execute("CREATE TABLE " . self::ET_ARCHIVE_TABLE . " AS SELECT * FROM et_ophtrconsent_type");
        }
