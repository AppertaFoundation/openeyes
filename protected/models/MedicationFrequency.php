 ...
 */
class MedicationFrequency extends BaseActiveRecordVersioned
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'medicationSets' => array(self::HAS_MANY, MedicationSetItem::class, 'default_frequency_id'),
        );
    }
     ...
     * @return MedicationFrequency the static model class
     */
