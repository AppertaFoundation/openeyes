...
/**
 * This is the model class for table "ref_medication_form".
 *
 * The followings are the available columns in table 'ref_medication_form':
 * @property integer $id
 ...
 */
class RefMedicationForm extends BaseActiveRecordVersioned
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'refMedicationSets' => array(self::HAS_MANY, 'RefMedicationSet', 'default_form'),
		);
	}
	 ...
	 * @return RefMedicationForm the static model class
	 */
