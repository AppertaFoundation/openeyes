 ...
 *
 * The followings are the available columns in table 'proc_set_assignment':
 * @property integer $id
...
class ProcedureSetAssignment extends BaseActiveRecordVersioned
{
    ...
    public function rules()
    {
        ...
        return array(
            array('proc_set_id, proc_id', 'required'),
            array('proc_set_id', 'numerical', 'integerOnly' => true),
            array('proc_id, last_modified_user_id, created_user_id', 'length', 'max' => 10),
            array('last_modified_date, created_date', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, proc_set_id, proc_id, last_modified_user_id, last_modified_date, created_user_id, created_date', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return ProcedureSetAssignment the static model class
     */
