...
/**
 * This is the model class for table "medication_allergy_assignment".
 *
 * The followings are the available columns in table 'medication_allergy_assignment':
 * @property integer $id
...
class MedicationAllergyAssignment extends BaseActiveRecordVersioned
{
	...
	{
		return 'medication_allergy_assignment';
	}
	...
	public function rules()
	{
		...
		return array(
			array('medication_id, allergy_id', 'required'),
			...
			array('id, medication_id, allergy_id, last_modified_user_id, last_modified_date, created_user_id, created_date', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MedicationAllergyAssignment the static model class
	 */
