...
class EyeSelector extends BaseCWidget
{
    ...
    public function renderRight()
    {
        ...
        echo CHtml::checkBox($this->inputNamePrefix . "[right_eye]", in_array($this->selectedEyeId, [\Eye::RIGHT, \EYE::BOTH]), ['class' => 'js-right-eye', 'data-data-eye-side' => 'right']) . ' R';
    ...
    {
        echo CHtml::openTag('label', ['class' => 'inline highlight']);
        echo CHtml::checkBox($this->inputNamePrefix . "[left_eye]", in_array($this->selectedEyeId, [\Eye::LEFT, \EYE::BOTH]), ['class' => 'js-left-eye', 'data-data-eye-side' => 'left']) . ' L';
        echo CHtml::closeTag('label');
    }
