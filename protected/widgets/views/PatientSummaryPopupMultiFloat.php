...
?>
    ...
    <div class="patient-popup-demographics oe-patient-quick-overview" style="display:block;" data-patient-id="<?= $this->patient->id ?>">
    ...
    <div class="oe-patient-quick-overview patient-summary-quicklook" style="display:none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
        <?php
    ...
    <div class="oe-patient-quick-overview patient-popup-management" style="display: none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
        <?php
...
<!--patient popup management-->
    ...
    <div class="oe-patient-quick-overview patient-popup-allergies-risks" style="display: none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
        <?php
...
<?php if (Yii::app()->getModule('OETrial')) { ?>
    <div class="oe-patient-quick-overview patient-popup-trials" style="display: none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
        <?php
