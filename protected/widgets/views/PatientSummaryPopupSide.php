...
?>
    ...
    <div class="patient-popup-demographics oe-patient-quick-overview side-panel" style="display:block;" data-patient-id="<?= $this->patient->id ?>">
    ...
    <div class="oe-patient-quick-overview side-panel patient-summary-quicklook" style="display:none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
            <?php
    ...
    <div class="oe-patient-quick-overview side-panel patient-popup-management" style="display: none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
        <?php $this->render('application.widgets.views.PatientMeta'); ?>
        <div class="data-group">
    ...
    <div class="oe-patient-quick-overview side-panel patient-popup-allergies-risks" style="display: none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
            <?php
...
<?php if (Yii::app()->getModule('OETrial')) { ?>
    <div class="oe-patient-quick-overview side-panel patient-popup-trials" style="display: none;" data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
            <?php
            ...
            ?>
            <?php
                $this->widget('application.modules.OETrial.widgets.PatientTrialSummary',
