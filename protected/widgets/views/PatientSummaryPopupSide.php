...
?>
    ...
    <div class="patient-popup-demographics oe-patient-quick-overview side-panel" style="display:none;"
    ...
    <div class="oe-patient-quick-overview side-panel patient-summary-quicklook" style="display:none;"
         data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
    ...
    <div class="oe-patient-quick-overview side-panel patient-popup-management" style="display: none;"
         data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
    ...
    <div class="oe-patient-quick-overview side-panel patient-popup-allergies-risks" style="display: none;"
         data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
...
<?php if (Yii::app()->getModule('OETrial')) { ?>
    <div class="oe-patient-quick-overview side-panel patient-popup-trials" style="display: none;"
         data-patient-id="<?= $this->patient->id ?>">
        <div class="close-icon-btn">
            <i class="oe-i remove-circle medium"></i>
        </div>
        ...
        <?php
            $this->widget(
                'application.modules.OETrial.widgets.PatientTrialSummary',
