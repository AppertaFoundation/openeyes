...
--
-- Table structure for table `common_ophthalmic_disorder`
--
...
--
-- Table structure for table `common_systemic_disorder`
--
...
(3577000, 'Retinal lattice degeneration (disorder)', 'Retinal lattice degeneration', 0),
(22298006, 'Myocardial infarction (disorder)', 'Myocardial infarction', 1),
(31341008, 'Vitreous hemorrhage (disorder)', 'Vitreous haemorrhage', 0),
(44054006, 'Diabetes mellitus type 2 (disorder)', 'Diabetes mellitus type 2', 1),
(46635009, 'Diabetes mellitus type 1 (disorder)', 'Diabetes mellitus type 1', 1),
(57190000, 'Myopia (disorder)', 'Myopia', 0),
(59621000, 'Essential hypertension (disorder)', 'Essential hypertension', 1),
(247081001, 'Posterior vitreous detachment (disorder)', 'Posterior vitreous detachment', 0);
...
INSERT INTO `element_history` (`id`, `event_id`, `description`) VALUES
(1, 1, 'Test HPC 2 2'),
(2, 2, 'test 2 2'),
(3, 4, 'HPC test 4 5 6'),
(4, 3, 'asdfasdf '),
(5, 6, 'Adnexal event creation test'),
(6, 7, 'HPC cataract test asdf'),
(7, 9, 'asdfasdf'),
(8, 10, 'asdfasdfasd fasdf'),
(9, 11, 'asdfasdf asdf asd aweaweawe'),
(10, 12, 'asdfasdf'),
(11, 13, 'asdfasdf'),
(12, 14, 'asdfasd'),
(13, 15, 'asdfasdfasdf asdf'),
(14, 16, 'qwerqwerqwer eht hrt'),
(15, 17, 'asdfas dfasdf asdf');
...
(4, 1, 9, '2011-02-23 18:12:21', NULL),
(5, 3, 7, '2011-02-23 18:12:45', NULL),
(6, 3, 9, '2011-02-23 18:14:51', NULL);
...
(1, 12, 4, '1234', 4),
(2, 1, 0, 'Loss of vision', 0),
(3, 1, 0, 'Peripheral field loss', 0),
(4, 1, 0, 'Distortion of field', 0),
(5, 1, 0, 'Central visual disturbance', 0);
