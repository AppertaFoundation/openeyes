...
# Script to fetch and process examinations from the community portal
...
if ! php $WROOT/protected/yiic portalexams
then
	error_exit "Failed to fetch and process portal examinations"
fi
