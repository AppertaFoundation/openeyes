...
if ! php $WROOT/protected/yiic docmandelivery
then
	error_exit "Failed to send electronic correspondence"
fi

[ ! -z $OE_DOCMAN_EXPORT_DIRECTORY ] && ls -l $OE_DOCMAN_EXPORT_DIRECTORY | :
