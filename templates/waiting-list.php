				...
				<div class="panel filters-panel row">
					...
					<div class="large-9 column text-right">
						...
						<div class="panel panel-orange">
								...
								<input class="small hasDatepicker" id="adminconfirmdate" type="text" name="adminconfirmdate" style="width:110px" />
						</div>
						<div class="panel panel-orange">
						...
						<table>
							<tbody>
								...
								<tr class="even">
									...
									<td>
										<select name="firm-id" id="firm-id"><option value="">All firms</option></select>
									</td>
									<td>
									...
									<td>
										<input type="text" size="12" name="hos_num" id="hos_num" value="">
									</td>
									<td>
										<button type="submit" class="classy tall green" style="float: right;"><span class="button-span button-span-green">Search</span></button>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table class="waiting-list">
						  <tbody>
						    <tr>
						      ...
						      <th>
						        <input style="margin-top: 0.4em;" type="checkbox" id="checkall" value="">
						        All
						      </th>
						    </tr>

						    <tr class="waitinglistEven">
						      <td class="letterStatus waitinglistWhite">
						    ...
						    <tr class="waitinglistOdd">
						      <td class="letterStatus waitinglistGreen">
						        <img src="/assets/2f6770e4/img/letterIcons/invitation.png" alt="Invitation" width="17" height="17">
						        <img src="/assets/2f6770e4/img/letterIcons/letter1.png" alt="1st reminder" width="17" height="17">
						      </td>
						      <td class="patient">
						    ...
						    <tr class="waitinglistEven">
						      <td class="letterStatus waitinglistPurple">
						      </td>
						      <td class="patient">
